...
If you are unsure how directories work, we suggest the *Programming Historian* lesson ["Introduction to the Bash Command Line"](https://programminghistorian.org/en/lessons/intro-to-bash).
...
-   Finally, also consult David Mimno's [bibliography of topic modeling
  ...
  [Bash Command Line]: https://programminghistorian.org/en/lessons/intro-to-bash
  ...
  [dangers]: /blog/the-myth-of-text-analytics-and-unobtrusive-measurement/
  ...
  [Guided Tour to Topic Modeling]: /blog/topic-modeling-for-humanists-a-guided-tour/
  ...
  [Windows]: https://programminghistorian.org/en/lessons/windows-installation
  [Mac]: https://programminghistorian.org/en/lessons/mac-installation
  [Linux]: https://programminghistorian.org/en/lessons/linux-installation
