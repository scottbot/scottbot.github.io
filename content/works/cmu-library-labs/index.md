...
doi: 10.1184/R1/13522718
original_url: https://doi.org/10.1184/R1/13522718
sbw: SBW-033
citation: Weingart, Scott B., and Matthew Lincoln. 2021. CMU Library Labs (2020-2024). CMU Library Labs White Paper. Carnegie Mellon University. 455911 Bytes. https://kilthub.cmu.edu/articles/preprint/CMU_Library_Labs_2020-2024_/13522718.
abstract: 'A planning document outlining the structure, mission, and operations of

  CMU Library Labs, a successor program to a five-year, $2 million A. W.

  Mellon Foundation grant supporting Digital Humanities at Carnegie Mellon

  University. The document describes CMU Library Labs'' identity, personnel,

  and five core initiatives — an Incubator, a Stewardship Initiative, a

  graduate Fellowship Program, a Digital Humanities Literacy Institute, and

  an Advisory Board — together with detailed templates for calls for

  proposals, project charters, graduation checklists, sunset plans, and

  multi-tier service-level agreements (Year One Warranty, One Year

  Continuation Agreement, and Long Term Service Agreement).'
bibkey: weingartCMULibraryLabs2021
caveat_extra: For example, links are currently broken and need to be fixed.
---
...
[http://dx.doi.org/10.1184/R1/13522718](/works/cmu-library-labs/)
...
![Figure: CMU Library Labs project timeline showing the staggered schedule for four projects across charter, incubation, full-warranty, maintenance, and stewardship phases, spanning Spring 2020 through Summer 2027.](images/SBW-033-fig-001-project-timeline.png)
