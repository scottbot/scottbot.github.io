...
The fifth and sixth (coming soon…) installment of Networks Demystified <!-- page 2 --> will be a bit more applied than the previous bunch ([1](/blog/demystifying-networks/) network basics, [2](/blog/networks-demystified-2-degree/) degree, [3](/blog/networks-demystified-3-the-power-law-rant/) power laws, [4](/blog/networks-demystified-4-co-citation-analysis/) co-citation analysis). Like many of my recent posts, this one is in response to a [Twitter conversation](https://twitter.com/mwidner/status/380034784669347840):
