...
Despite a lack of South American and African attendees, this is still a pretty encouraging map for DH2015, especially compared to earlier years. The geographic diversity of attendees is actually mirrored in the conference submissions ([analyzed here](/blog/submissions-to-digital-humanities-2015-pt-3/)), which to my mind means the ADHO decision to hold the conference somewhere other than North America or Europe succeeded in its goal of diversifying the organization. From what I hear, they hope to continue this trend by moving to a three-year rotation, between North America, Europe, and elsewhere. At least from this analysis, that’s a successful strategy.

![Stacked bar chart: DH submissions broken down by UN macro-continental regions](images/img-002.png)

<!-- page 4 -->

*Figure 2. DH submissions broken down by UN macro-continental regions (details in an [earlier post](/blog/submissions-to-digital-humanities-2015-pt-3/)).*
...
![World map: ADHO conference author locations, 2004-2013](images/img-003.png)
...
![Stacked bar chart: geographic home of authors to ADHO conferences 2004-2013, with European host years highlighted](images/img-004.png)
...
![Line chart: regional diversity of authors at ADHO conferences, 2004-2013](images/img-005.png)
...
![Line chart: gender ratio of authors to presentations at DH2004-DH2013, with the first-authorship ratio in red](images/img-006.png)
...
This representation issue is further reflected by the [topical analysis of DH2015](/blog/acceptances-to-digital-humanities-2015-part-2/), which shows that only 10% of presentations are tagged as cultural studies, and only 1% as gender studies. Previous years show a similar low number for both topics. (It’s worth noting that cultural studies tend to have a slightly lower-than-average acceptance rate, while gender studies has a slightly higher-than-average acceptance rate. Food for thought.)
