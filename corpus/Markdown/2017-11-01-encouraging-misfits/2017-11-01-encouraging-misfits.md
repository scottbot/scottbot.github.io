...
post_date_visible: "November 1, 2017"
...
tags: ["academia", "disciplinarity", "interdisciplinarity"]
...
archive_timestamp: "20190916154321"

language: "en"
comments_preserved: true
comment_count: 0

source_pdf: "Weingart - 2017 - Encouraging Misfits.pdf"
source_pdf_sha256: "27173256985533c3797dab37d8d174d5d35cf2ababaa8d289fbd91371663f9bb"
extraction_date: "2026-08-01"
extraction_tool: "claude scholarly-blog-html-to-markdown skill (from Wayback print PDF)"
extraction_notes: |
  Source is a browser print-to-PDF (5 pages, printed 4/7/2026) of the Wayback
  snapshot 20190916154321 of scottbot.net/encouraging-misfits/. Print
  header/footer (Wayback banner, page title, truncated archive URL, "N of M",
  print timestamp) and site chrome ("the scottbot irregular" masthead, "data
  are everywhen" tagline, "Proudly powered by WordPress" footer, css.php stats
  beacon) stripped. Post date, category, and tags taken from the printed
  byline block on page 4 (byline reads "scott b. weingart"); original URL
  recovered from the permalink on the printed dateline. The PDF text layer
  mapped ligature glyphs (fi/ff/fl/ffi) to control characters; restored from
  context. Hyperlinks reconstructed from PDF link annotations, with Wayback
  /web/<ts>/ prefixes stripped to original URLs. One footnote (WordPress
  "Notes:" block) converted to Markdown footnote syntax; back-arrow stripped.
  Images: 1 figure extracted (img-001); author-avatar thumbnail beside the
  byline skipped as chrome. No reader comments were present in the snapshot
  (0 preserved). Source typos kept verbatim (e.g. "antidsciplinary", "has no
  little place"). Page anchors mark print-page boundaries; print page 5
  contained only site-footer chrome.
...
![Dramatic rendition of types of -disciplinarity](images/img-001.png)
