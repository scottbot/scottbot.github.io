...
categories: ["theory"]
tags: ["big data", "data analysis", "digital humanities", "literary history", "macroanalysis"]
...
archive_date: "2015-04-04"
archive_timestamp: "20150404211724"

language: "en"
comments_preserved: true
comment_count: 3

source_pdf: "Weingart - 2015 - Not Enough Perspectives, Pt. 1.pdf"
source_pdf_sha256: "fa9841c6ab2ee563c1f7b11bba5ab09cc703240f063fdec813c707d182aea189"
extraction_date: "2026-08-02"
extraction_tool: "claude scholarly-blog-html-to-markdown skill (from Wayback print PDF)"
extraction_notes: |
  Post date confirmed as 2015-03-29 from the Wayback capture of the blog's monthly archive
  page (scottbot.net), which prints the dateline the single-post print omitted.
  Source is a Firefox/cairo browser print-to-PDF (17 pages, printed 4/4/2026)
  of Wayback snapshot 20150404211724 of the scottbot.net/HIAL post
  (Independent Publisher theme). PROVENANCE CAVEATS: (1) the theme printed no
  dateline. Internal evidence puts the post in the second half of March 2015:
  its figures live in wp-content/uploads/2015/03, it links posts and tweets
  from 19-24 March 2015, the first two reader comments are dated 29 March 2015,
  and the snapshot is 2015-04-04. Since no dateline was printed, post_date is
  ...
  but the comment-reply links ("?p=41271&replytocom=9508#respond" and two
  others) give the permalink exactly:
  http://www.scottbot.net/HIAL/?p=41271. archive_url is that permalink under
  the printed timestamp.
  Chrome stripped: print header/footer, Wayback banner, the "in theory"
  category line (-> YAML), the printed title (re-emitted as the H1), the
  "Write a Comment" heading and its Genericons glyph, the three "Reply to ..."
  links, the commenters' avatar images, the "READERS WHO SHARED THIS" widget
  (links to a Digital Literary Studies round-up and a David Bamman post), the
  RELATED CONTENT BY TAG cloud (5 tags -> YAML), and the "Independent Publisher
  empowered by WordPress" footer credit.
  The Andrew Piper epigraph and the Piper / Moretti / Tangherlini & Leonard /
  Underwood pull quotes (printed in italics indented at x=97.2) are rendered as
  blockquotes with single italic spans. Three bulleted lists preserved.
  The post's eight footnotes (printed as tiny superscript digits in the body
  and a "Notes:" list with return-arrows at the end) were converted to Markdown
  footnote syntax [^1]-[^8]; superscript positions restored from the print's
  marker coordinates, the "Notes:" label and the return-arrows (↩) dropped as
  apparatus chrome.
  Images: 8 files at native raster resolution. Three of them (the Jockers plot
  figure, the Moretti book cover and the Google-ngram chart) straddle a print
  page break; in each case the print rendered a sliver at the foot of one page
  and then the WHOLE raster again on the next, so the uncropped embedding was
  used and the sliver ignored. img-002, img-003 and img-006 keep their
  hyperlinks to the full-size uploads (poa21.png,
  Novel-Conversions-Diagram-Final.001.Cropped1.jpg, wonderful.png); the rest
  carry no link annotation. img-001 is the theme's featured-image banner above
  the title: a smaller (700x442) rendition of the same tsundoku illustration
  that appears in the body at 1202x764 as img-005, kept as its own file
  because the two rasters differ in resolution. The three commenter avatars were skipped as chrome. Captions kept
  as italic caption paragraphs with their hyperlinks.
  Comments: all 3 reader comments preserved verbatim (tedunderwood and
  heatherfroehlich, 29 March 2015; Ioannis Lagamtzis, 31 March 2015), rendered
  as depth-1 blockquotes with the commenters' site links on their names.
  ...
  verbatim: "the first month's of President Obama's bid", "Picketty's",
  "humanties" and "readership" in the comments, and the double space in
  "a weird term.  The Forgotten Read".
