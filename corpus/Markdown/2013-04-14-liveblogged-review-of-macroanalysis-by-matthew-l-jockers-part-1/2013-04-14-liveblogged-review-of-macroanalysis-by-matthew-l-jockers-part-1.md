...
categories: ["reviews"]
tags: ["data analysis", "digital humanities", "history", "literary history", "macroanalysis", "methodologies", "review", "text analysis"]
...
archive_timestamp: "20150606143720"

language: "en"
comments_preserved: false
comment_count: 0

source_pdf: "Weingart - 2013 - Liveblogged Review of Macroanalysis by Matthew L. Jockers, Part 1.pdf"
source_pdf_sha256: "10696706f2e6f24a74cb8677a8708d44239c8ec2011c05779f339c78af900fab"
extraction_date: "2026-08-02"
extraction_tool: "claude scholarly-blog-html-to-markdown skill (from Wayback print PDF)"
extraction_notes: |
  Post date confirmed as 2013-04-14 from the Wayback capture of the blog's monthly archive
  page (scottbot.net), which prints the dateline the single-post print omitted.
  Source is a Firefox print-to-PDF (6 pages, printed 3/27/2026) of the
  Wayback snapshot 20150606143720 of the live scottbot.net/HIAL post
  ("Independent Publisher" theme). Print header/footer, the Wayback banner
  line, the "Write a Comment" stub, the "RELATED CONTENT BY TAG" cloud
  (feeds YAML tags), the category line "in reviews" (feeds YAML
  categories), and the theme footer were stripped. PROVENANCE: the print
  header truncates the snapshot URL; original_url ?p=34566 recovered from
  the corpus-wide selflink index (Part 2's own print links back to this
  post). This theme prints NO dateline: post_date "2013-04" inferred (both
  post images live under /wp-content/uploads/2013/04/; the Travis Brown
  tweet quoted in the text is dated 2013-04-11 by its Snowflake id) —
  month-only date FLAGGED in review notes; output folder uses a year-only
  slug. The intro's "Read Part 2, Part 3, ..." line: only "Part 2" carries
  a link annotation (?p=34775), kept; "Part 3, ..." prints as plain text
  (never linked in this snapshot). Images: both content images printed
  SPLIT across page boundaries and were re-stitched from the embedded
  slices at native resolution: img-001 (Moretti, Graphs Maps and Trees
  figure; 656x1024 + 658x165) and img-002 (Asimov Foundation comic strip;
  702x14 + 700x199); both keep their full-size-jpg links and their printed
  captions ("From Moretti's Graphs, Maps, and Trees"; "The story of
  Foundation in a nutshell. Via c0ders." with the c0ders link) as the
  following paragraph. "Part I: Foundation" printed as an Arial-Bold
  sub-heading -> H2. No reader comments were printed (comment_count 0 =
  "not in print"). All links from annotations (Wayback /web/<ts>/ prefix
  stripped).
...
I just got Matthew L. Jocker’s *Macroanalysis* in the mail, and I’m excited enough about it to liveblog my review. Here’s my review of part I (Foundation), all chapters. Read [Part 2](http://www.scottbot.net/HIAL/?p=34775), Part 3, …
