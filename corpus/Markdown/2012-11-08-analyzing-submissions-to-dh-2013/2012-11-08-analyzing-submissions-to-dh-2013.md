...
authors:
  - family: "Weingart"
    given: "Scott B."
    url: "http://www.scottbot.net/HIAL/"
post_date: "2012-11-08"
modified_date: "2014-04-10"

blog_title: "the scottbot irregular"
blog_url: "http://www.scottbot.net/HIAL/"
blog_platform: "WordPress 4.3.1"

categories: ['method', 'personal research']
tags: ['data analysis', 'dhconf', 'digital humanities', 'methodologies', 'network analysis', 'scholarly communication', 'visualizations']
...
archive_date: "2015-09-22"
archive_timestamp: "20150922065706"

description: |
  Digital Humanities 2013 is on its way; submissions are closed, peers will be reviewing them shortly, and (most importantly for this post) the people behind the conference are experimenting with a n...
language: "en"

comments_preserved: false
comment_count: 0

source_html: "1779230924217_Analyzing_submissions_to_Digital_Humanities_2013___the_scottbot_irregular.htm"
source_html_sha256: "4a698f00bf8cff2aac1645e96c9a82e7defc0a1dded218c93bc31a2a76be72c3"
extraction_date: "2026-05-19"
extraction_tool: "claude scholarly-blog-html-to-markdown skill"
extraction_notes: |
  Wayback toolbar and injected scripts removed; rewritten URLs restored to
  originals. Post body taken from article#post-24437 > .entry-content.
  All 5 figures localized from the user-supplied PNG uploads (no network
  fetch needed) and matched to the post by filename. WordPress [caption]
  shortcode markup converted to image + italicized caption line. No reader
  comments were present in the snapshot. No footnotes in the source.
...
document, they are connected by an edge (see [Networks Demystified Pt. 1](http://www.scottbot.net/HIAL/?p=6279)
