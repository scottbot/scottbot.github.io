...
original_url: "http://www.scottbot.net/HIAL/?p=11621"
archive_url: "https://web.archive.org/web/20120823132004/http://www.scottbot.net/HIAL/?p=11621"
archive_date: "2012-08-23"
archive_timestamp: "20120823132004"

language: "en"
comments_preserved: false
comment_count: 0

source_pdf: "Weingart - 2012 - Flow and Empty Space.pdf"
source_pdf_sha256: "e245c6d83131ea071ea64bb9dd2684c668fb55b8dcaf9ff926a4a5d77d4c6f68"
extraction_date: "2026-08-02"
extraction_tool: "claude scholarly-blog-html-to-markdown skill (from Wayback print PDF)"
extraction_notes: |
  Post date confirmed as 2012-02-19 from the Wayback capture of the blog's monthly archive
  page (scottbot.net), which prints the dateline the single-post print omitted.
  Converted from a Firefox READER-VIEW print-to-PDF (2/27/2026) of the
  Wayback Machine snapshot 20120823132004 of the scottbot.net/HIAL post.
  Reader view strips all site chrome, so none was printed; only the print
  header/footer was removed here. The permalink ?p=11621 was recovered from
  the post's own footnote anchor annotations
  (http://www.scottbot.net/HIAL/?p=11621#note-11621-1), giving exact
  original_url and archive_url. PROVENANCE CAVEATS: (1) reader view prints
  NO dateline; the post is from 2012 (PDF filename; image upload paths
  /uploads/2012/02/ and the reference to "Chicago APA" suggest February
  2012), so post_date is the bare year and the output folder uses a
  year-only slug — flagged in review notes. (2) Reader view shows no
  categories/tags/comments; those fields are empty/zero, meaning "not in
  print", not "none existed". Blockquotes (Tao Te Ching epigraph with
  -Laozi attribution; Deacon whirlpool passage with "…" break, italicized
  emphasis-added paragraph, and "[Deason, 2009, emphasis added]"
  attribution; Elijah Meeks model quote) reconstructed from the print
  indent. The post's one footnote (superscript 1 after "plane-ride home")
  converted to Markdown footnote syntax from the "Notes:" list; its return
  link stripped. Two images extracted at native raster resolution, each
  kept hyperlinked to its full-size wp-content upload, captions preserved
  ("Look! It's me in a candy store!"; "Self-Organizing System
  (http://www.flickr.com/photos/lapstrake/3164577339/)"). Hyperlinks
  recovered from PDF link annotations and un-rewritten from Wayback form.
  Source spellings kept verbatim, including "Deason" for Deacon and
  "Susuki" for Suzuki.
bibkey: "weingartFlowEmptySpace2012"
---
...
[![Look! It's me in a candy store!](images/img-001.png)](http://www.scottbot.net/HIAL/wp-content/uploads/2012/02/P1010240.jpg)
...
[![Self-Organizing System](images/img-002.png)](http://www.scottbot.net/HIAL/wp-content/uploads/2012/02/3164577339_8fd4446cb7_o.jpg)
