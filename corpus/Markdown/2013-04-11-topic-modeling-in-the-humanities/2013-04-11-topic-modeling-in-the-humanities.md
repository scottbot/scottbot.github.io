...
archive_timestamp: "20130621224953"

language: "en"
comments_preserved: false
comment_count: 0

source_pdf: "Weingart - 2013 - Topic Modeling in the Humanities.pdf"
source_pdf_sha256: "2f4a4daebbcd5f73d8704b75467a4c38ff09327ead9d8bde4cbb3633525c6b2e"
extraction_date: "2026-08-02"
extraction_tool: "claude scholarly-blog-html-to-markdown skill (from Wayback print PDF)"
extraction_notes: |
  Post date confirmed as 2013-04-11 from the Wayback capture of the blog's monthly archive
  page (scottbot.net), which prints the dateline the single-post print omitted.
  Source is a Firefox print-to-PDF (2 pages, printed 3/27/2026) of the
  Wayback snapshot 20130621224953. ORIGINAL URL NOT RECOVERABLE: the print
  header truncates the snapshot URL ("http://www.scottbot.net..."), this
  print view contains no self-referential links (no Reply/comment links),
  and no other print in the uploaded corpus links to this post;
  original_url and archive_url are therefore left empty, with only the
  timestamp recorded. POST DATE ONLY PARTIALLY DETERMINED: no dateline,
  category, tag, or comment block appears in this minimal print view; the
  post is bounded between early April 2013 (announces the release of JDH
  2:1, published April 2013; featured screenshot uploaded to
  wp-content/uploads/2013/04/; the community appendix is promised "in
  May" as future) and the 2013-06-21 snapshot. post_date recorded as the
  bare year "2013" and the folder uses the year-only slug. One image
  extracted from the embedded raster at native 1026x502 (Graham &
  Milligan MALLET screenshot), hyperlinked to its full-size wp-content
  upload (link kept, Wayback prefix stripped); its roman caption kept as
  body text. Print auto-hyphenation reversed (1 join); the line-end
  hyphen in "20-person" is the source's own compound hyphen and was
  restored. Source typos kept verbatim (e.g. "about he and I guest
  editing", "the difficulty in in stuffing", "as much we do", the double
  space after "the JDH,"). Hyperlinks reconstructed from PDF link
  annotations with Wayback prefixes stripped.
bibkey: "weingartTopicModelingHumanities2013"
---

# Topic Modeling in the Humanities

The cat is out of the bag: The Journal of Digital Humanities (2:1), [special issue on topic modeling](http://journalofdigitalhumanities.org/2-1/), has been released. It’s a fairly apt phrase, because the process of editing the issue felt a bit like stuffing a cat in a bag. When [Elijah Meeks](https://dhs.stanford.edu/author/emeeks/) approached the *JDH* editors about he and I guest editing an issue on topic modeling, I don’t think either of us quite realized exactly what that would entail. This post is not about the issue or its contents; Elijah and I [already wrote that introduction](http://journalofdigitalhumanities.org/2-1/dh-contribution-to-topic-modeling/), where we trace the history of topic modeling in the humanities and frame the articles in the issue. Instead, I’d like to take a short post waxing a bit more reflexive than is usual for this blog, discussing my first experience guest editing a journal and how it all came together. Elijah’s similar post can be found [here](https://dhs.stanford.edu/the-digital-humanities-as/the-digital-humanities-as-a-movement-expressed-in-a-method-enshrined-in-a-tool/).
