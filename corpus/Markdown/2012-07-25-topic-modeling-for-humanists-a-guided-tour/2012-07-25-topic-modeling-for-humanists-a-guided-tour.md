...
post_date: "2012-07-25"
post_date_visible: "July 25, 2012"
...
archive_date: "2012-08-23"
archive_timestamp: "20120823001001"

language: "en"
comments_preserved: false
comment_count: 0

source_pdf: "Weingart - 2012 - Topic Modeling for Humanists A Guided Tour.pdf"
source_pdf_sha256: "2223c84a9c55984a2dc77360045907ff4449d5454830694870f8fc75af04505c"
extraction_date: "2026-08-02"
extraction_tool: "claude scholarly-blog-html-to-markdown skill (from Wayback print PDF)"
extraction_notes: |
  Source is a Firefox print-to-PDF (5 pages, landscape, printed 3/27/2026)
  of the Wayback snapshot 20120823001001 of www.scottbot.net/HIAL/?p=19113
  (full permalink visible in the print header). Print header/footer stripped.
  This print view shows no dateline, categories, tags, or comments. post_date
  2012-07-25 and category "method" taken from the WordPress "Related" widget
  printed in "Weingart - 2019 - Seeking New Physics.pdf" ("Topic Modeling for
  Humanists: A Guided Tour / July 25, 2012 / In 'method'"); post_date_visible
  records that widget's date format. Section headings restored from font
  sizes (11.5pt bold = H2, 9pt bold = H3). Six quoted passages from the
  reviewed posts/articles rendered as blockquotes; the two-paragraph
  Underwood quote straddles the p3/p4 print break and is joined, with the
  page-3 anchor after it. One image (Elijah Meeks topic network, 1489x1020)
  extracted at native resolution; it was hyperlinked to the full-size upload
  (weak_topic_paper.png) and that hyperlink is kept; its caption line (with
  the Elijah Meeks link) kept as body. Ligature glyphs in the quoted Mimno
  passage normalized to ASCII (fi/fl). Hyperlinks reconstructed from PDF link
  annotations with Wayback /web/<ts>/ prefixes stripped. Source spacing kept
  verbatim (e.g. "Afghanistan War  Troops", "friends  in 2002").
...
The computer gets a bunch of texts and spits out several lists of words, and we are meant to think those lists represent the relevant “topics” of a corpus. The algorithm is constrained by the words used in the text; if Freudian psychoanalysis is your thing, and you feed the algorithm a transcription of your dream of bear-fights and big caves, the algorithm will tell you nothing about your father and your mother; it’ll only tell you things about bears and caves. It’s all text and no subtext. Ultimately, LDA is an attempt to inject semantic meaning into vocabulary; it’s a bridge, and often a helpful one. Many [dangers face those who use this bridge without fully understanding it](http://www.scottbot.net/HIAL/?p=16713), which is exactly what the rest of this post will help you avoid.
