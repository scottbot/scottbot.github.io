...
tags: ["history", "history of science", "methodologies", "philosophy of science", "relativity", "theory"]
...
archive_date: "2015-10-24"
archive_timestamp: "20151024093435"

language: "en"
comments_preserved: false
comment_count: 0

source_pdf: "Weingart - 2014 - Understanding Special Relativity through History and Triangles (pt. 1).pdf"
source_pdf_sha256: "1f991f6e235d5a4ce7af51dcc042346fd28e46af747da2fee8c5fe0e4c008c27"
extraction_date: "2026-08-02"
extraction_tool: "claude scholarly-blog-html-to-markdown skill (from Wayback print PDF)"
extraction_notes: |
  Post date confirmed as 2014-02-23 from the Wayback capture of the blog's monthly archive
  page (scottbot.net), which prints the dateline the single-post print omitted.
  Source is a Firefox/cairo browser print-to-PDF (11 pages, printed 3/31/2026)
  of Wayback snapshot 20151024093435 of the scottbot.net/HIAL post
  (Independent Publisher theme). PROVENANCE CAVEATS: (1) the theme printed no
  dateline, so the exact post date is not recoverable offline; the post's
  figures live in wp-content/uploads/2014/02, indicating February 2014, and
  the source PDF's own filename assigns 2014 — post_date is therefore the bare
  year and the output folder uses a year-only slug (flagged in review notes).
  (2) The print header truncates the snapshot URL
  ("https://web.archive.org/web/20151024093435/http://www.scottbot.net..."),
  so the permalink was recovered from a cross-PDF link index over the whole
  Blog Posts folder: the sidebar of the "Breaking the Ph.D. model using pretty
  pictures" print links this post's title to
  http://www.scottbot.net/HIAL/?p=40456. archive_url is that permalink under
  the exact printed timestamp.
  Chrome stripped: print header/footer, Wayback banner line, the "in
  miscellanea" category line (-> YAML categories), the post title (re-emitted
  as the H1), the "Write a Comment" heading and its Genericons glyph, the
  RELATED CONTENT BY TAG cloud (6 tags -> YAML), and the "Independent
  Publisher empowered by WordPress" footer credit. No comments were printed
  (comment_count 0).
  The print split the heading "Relativity Before Einstein" across the p2/p3
  page break: the descenders re-rendered at the top of p3 leave a stray 'y'
  glyph in the text layer, which was dropped as a print artifact (the heading
  itself is complete on p2).
  Images: 3 files, extracted from the embedded rasters at native resolution.
  img-001.png (640x480 aether diagram) is pixel-identical to the theme's
  featured-image banner on p1, so one file serves both occurrences — the p1
  occurrence is unlinked, the in-body occurrence keeps its hyperlink to the
  full-size upload (640px-AetherWind.svg1_.png). img-002.png (1026x745,
  Galileo's relativity figure) and img-003.png (607x428, First Solvay
  Conference photograph) keep their hyperlinks to the 5.21.jpg and sol11l1.jpg
  uploads. Both the aether and the Solvay rasters straddle a print page break
  and were taken from the un-cropped embedding (the page-break copy is a crop
  of the same raster). The aether raster carries an /SMask alpha channel; it
  was composited over white (as the browser rendered it) so the black line
  work and the "Luminiferous Ether" label remain visible.
  Captions ("Galileo's relativity [via]...", "The earth
  moving through the ether. [via]", "First Solvay Conference. [via]") are kept
  as italic caption paragraphs with their [via] hyperlinks.
  ...
  verbatim ("The story movies forward", "the an objects", "Ernst Mach, A
  philosopher", "in the seven year's following", "Lets skip ahead").
...
![The Earth’s orbit around the Sun drawn inside a field of dashed lines and arrowheads labelled “Luminiferous Ether” (post featured image)](images/img-001.png)
...
[![Figure 5.2, Galileo’s Relativity (Equivalence) Of Uniform Velocities — three panels of Galileo in a ship’s cabin: at rest in port, accelerating away from the dock, and sailing at uniform velocity](images/img-002.png)](http://www.scottbot.net/HIAL/wp-content/uploads/2014/02/5.21.jpg)
...
[![The Earth’s orbit around the Sun drawn inside a field of dashed lines and arrowheads labelled “Luminiferous Ether”](images/img-001.png)](http://www.scottbot.net/HIAL/wp-content/uploads/2014/02/640px-AetherWind.svg1_.png)
...
[![Photograph of the participants of the First Solvay Conference, each figure labelled with a name (Nernst, Planck, Lorentz, Curie, Poincaré, Einstein and others)](images/img-003.png)](http://www.scottbot.net/HIAL/wp-content/uploads/2014/02/sol11l1.jpg)
