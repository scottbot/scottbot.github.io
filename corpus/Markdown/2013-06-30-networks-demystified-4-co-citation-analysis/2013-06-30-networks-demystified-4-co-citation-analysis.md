...
categories: ["method"]
tags: ["data analysis", "history", "history of science", "methodologies", "network analysis", "networks demystified", "scholarly communication", "sci2", "scientonomy", "social networks", "visualizations"]
...
archive_date: "2015-04-13"
archive_timestamp: "20150413205748"

language: "en"
comments_preserved: true
comment_count: 5

source_pdf: "Weingart - 2013 - Networks Demystified 4 Co-Citation Analysis.pdf"
source_pdf_sha256: "eed6abd7e58f912a5ef37053717c851ebdec29a22d720cb1fee6301e6457b6b9"
extraction_date: "2026-08-02"
extraction_tool: "claude scholarly-blog-html-to-markdown skill (from Wayback print PDF)"
extraction_notes: |
  Post date confirmed as 2013-06-30 from the Wayback capture of the blog's monthly archive
  page (scottbot.net), which prints the dateline the single-post print omitted.
  Source is a Firefox print-to-PDF (17 pages, printed 3/27/2026) of the
  Wayback snapshot 20150413205748 of the live scottbot.net/HIAL post
  ...
  SHARED THIS" widget, the "RELATED CONTENT BY TAG" cloud (feeds YAML
  tags), the category line "in method" (feeds YAML categories), and the
  theme footer were stripped. original_url ?p=38272 from the comment
  "replytocom" link annotations. This theme prints NO dateline: post_date
  "2013-06" inferred (all post images under /uploads/2013/06/; the
  in-text tweet id 349606786862559236 decodes to 2013-06-25; Healy's
  linked posts are 2013-06-18/24; earliest comment 2013-07-03) —
  month-only date FLAGGED in review notes; year-only slug. IMAGES: 7
  content images extracted at native raster resolution; Figures 1, 5 and
  7 printed split across page boundaries and were re-stitched from their
  embedded slices; Figure 3's complete raster was embedded on p6 (the p5
  slice is a duplicate crop and was not used twice). Each image keeps its
  click-through link and its printed caption as the following paragraph.
  IMPORTANT: Figure 6 (the author co-citation network of 15 HPS journals,
  FullPageMapOfHPS.png) is BROKEN in the archived snapshot — the print
  shows an empty frame, so no raster exists to extract. Its
  placeholder/link text ("Figure 6: ... Click to enlarge. [via me!]",
  hyperlinked to the full-size PNG) and its printed caption are preserved
  in place; the theme's featured-image area at the top of the page (the
  same broken Figure 6) printed only its caption text, kept verbatim as
  the opening paragraph before the H1. Commenter gravatars skipped as
  chrome. Kieran Healy's block quotation kept as a blockquote (print
  indent). 5 reader comments preserved verbatim (Brad [Wray]; Scott
  Weingart reply; a second top-level Scott Weingart comment; greg dl;
  Scott Weingart reply); Brad's salutation line break restored; Scott's
  commenter-name link (scottbot.net) noted in review notes, names bold
  per house style. All links from annotations (Wayback /web/<ts>/ prefix
  stripped).
...
This installment of Networks Demystified is the first one that’s actually applied. A few days ago, a discussion arose over twitter involving citation networks, and this post fills the dual purpose of continuing that discussion, and teaching a bit about basic citation analysis. If you’re looking for the very basics of networks, see [part 1](http://www.scottbot.net/HIAL/?p=6279) and [part 2](http://www.scottbot.net/HIAL/?p=6526). [Part 3](http://www.scottbot.net/HIAL/?p=17824) is a warning for anyone who feels the urge to say “power law.” To recap: nodes are the dots/points in the network, edges are the lines/arrows/connections.
