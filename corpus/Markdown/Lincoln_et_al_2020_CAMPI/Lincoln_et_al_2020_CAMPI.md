...
authors:
  - family: "Corrin"
    given: "Julia"
    affiliation: "Carnegie Mellon University Libraries; Carnegie Mellon University Archives"
  - family: "Davis"
    given: "Emily"
    affiliation: "Carnegie Mellon University Libraries; Carnegie Mellon University Archives"
  - family: "Lincoln"
    given: "Matt"
    affiliation: "Carnegie Mellon University Libraries; Carnegie Mellon University Library Lab"
  - family: "Weingart"
    given: "Scott"
    affiliation: "Carnegie Mellon University Libraries; Carnegie Mellon University Library Lab"
...
publisher_place: "Pittsburgh, PA"
issued: "2020"
year: 2020
doi: "10.1184/R1/12791807"
url: "https://github.com/cmu-lib/campi"
language: "en"
source_pdf: "Lincoln et al. - 2020 - CAMPI Computer-Aided Metadata Generation for Photo archives Initiative.pdf"
source_pdf_sha256: "640291e75d05afb145f8a937f1811db1c1bc55473f7aeb65fa6e94dd4632faf3"
page_count: 38
extraction_date: "2026-08-01"
extraction_tool: "claude scholarly-pdf-to-markdown skill"
extraction_notes: |
  Word-derived digital-native PDF (Microsoft Word via macOS Quartz), single column,
  38 pages. Metadata transcribed from the title page as printed (author order
  alphabetical); no network/Crossref access from this environment. All 15 numbered
  figures plus the unnumbered Appendix 1 architecture diagram cropped at 210 DPI
  (several are vector drawings rasterized from the page; text inside figures rides
  in the images and is not transcribed as prose). The one data table (p. 26, GCV-API
  label counts) reconstructed as a Markdown table; it has no header row in the
  source, so the header cells are empty. 39 footnotes converted to [^N] with
  definitions placed at the end of their printed page. The PDF carries no hyperlink
  annotations (Quartz stripped them), so link targets are lost: visible URLs are
  kept verbatim; styled anchor text (e.g. Django REST Framework, PostgreSQL, Vue,
  IIPImage on p. 38, and the title-page DOI) is rendered as [anchor](#) placeholders.
  Table of contents reformatted as a Markdown list with leader dots dropped and
  em-dash separators added before page numbers. Title-page CMU wordmark logo image
  omitted. Page-number folios removed and preserved as <!-- page N --> anchors
  (printed folio equals PDF page index). Heading levels: numbered X.Y -> ###,
  X.Y.Z -> ####; unnumbered "Key Findings" -> ###; unnumbered "Vocabularies and
  Tag Selection" / "Non-Specialist Description" (under 5.1.4) -> #####.
