...
post_date_visible: "January 15, 2019"
...
tags: ["full-stack dev", "hardware", "infrastructure"]
...
archive_date: "2019-05-24"
archive_timestamp: "20190524225906"

language: "en"
comments_preserved: true
comment_count: 40

source_pdf: "Weingart - 2019 - The Route of a Text Message.pdf"
source_pdf_sha256: "e18f034d65afc18f4d84e845c78a8bb7f9b72a92764dc628454cb808dd14b094"
extraction_date: "2026-08-02"
extraction_tool: "claude scholarly-blog-html-to-markdown skill (from Wayback print PDF)"
extraction_notes: |
  RELATIONSHIP TO the-route-of-a-text-message-a-love-story: this is the BLOG
  version of the piece, published on scottbot.net on 15 January 2019. Its own
  first line is a note pointing readers to "the more polished, professionally
  illustrated version of this piece at Motherboard|Vice" — that Motherboard
  version, "The Route of a Text Message, a Love Story"
  (https://motherboard.vice.com/en_us/article/kzdn8n/the-route-of-a-text-message-a-love-story),
  is converted separately under the slug the-route-of-a-text-message-a-love-story.
  The two are different publications of the same argument with different
  illustrations, wording and apparatus; this one additionally carries 40 reader
  comments. The slugs do not collide and neither conversion was altered.
  Source is a Firefox/cairo browser print-to-PDF (35 pages, printed 4/7/2026,
  11:09 AM) of Wayback snapshot 20190524225906. This is a FOURTH scottbot.net
  theme (Arial display face, Georgia body, Consolas for code, link colour
  #007acc). Provenance is exact: the post's own byline block on p25 prints the
  author, the dateline "January 15, 2019", the category "miscellanea" and the
  tags "full-stack dev, hardware, infrastructure", each with a link annotation,
  and the permalink is read off the print header and Wayback banner.
  IMAGES: 13 figures. Ten were extracted as embedded rasters at native
  resolution. Three (figures 3, 4 and 8 — the two PDU-layout diagrams and the
  SMS cellular-network diagram) are stored as 1-bit DeviceGray rasters that
  extract inverted (solid black), so they were captured instead as 300-dpi
  crops of the printed figure area, which is exactly what the page showed.
  Figure 2 is a single captioned figure made of two stacked rasters (the GSM
  03.38 character set and the GSM 03.38 escaped characters); both are kept, as
  img-003 and img-004, under the one printed caption. Every printed caption
  ("Fig 0. Capacitive touch." … "Fig 11. Negative space.") is preserved as an
  italic caption paragraph in its printed position. Alt text is descriptive and
  editor-supplied from the extracted figures. Commenter avatars and a 1x1-pixel
  tracking image on p35 were skipped as chrome.
  EMBEDDED VIDEO NOT RECOVERABLE: between the Feynman paragraph on p17 and its
  caption "Feynman discussing waves." on p18, the print left roughly half a page
  blank — an embedded video iframe that the browser did not render. No link
  annotation survives inside that blank area, so the embed's URL cannot be
  recovered from this PDF, and an editor-supplied placeholder line
  "[Embedded video — the print rendered the iframe as blank space and no URL for it survives in the PDF]"
  stands in its place, immediately before the caption. (The prose just above it
  links "Richard Feynman eloquently put it in 1983" to
  https://www.youtube.com/watch?v=1qQQXTMih1A, which is very likely the same
  lecture, but that is an inference and is NOT asserted in the body.)
  CODE: the print sets short data strings (binary, hex and the scrambled
  endianness example) in Consolas at a wider indent; they are emitted as fenced
  code blocks. One of them wraps across two printed lines on p15 and was
  rejoined.
  COMMENTS: the comments heading reads "46 thoughts on “The Route of a Text Message”", but that
  count includes 6 pingbacks as well as the 40 reader comments. Per the blog
  playbook, pingbacks are chrome rather than comments, so the 40 reader
  comments are preserved verbatim with their nesting (to depth 4) and
  comment_count is 40; the 6 pingbacks are recorded here instead:
  - Pingback: Week 01: Star Trek and Feedback Loops – Ryan Brazell
    https://sociology.ryanbrazell.net/2019/01/17/week-01-star-trek-and-feedback-loops/
  - Pingback: Technology’s dark forest – TechCrunch
    https://techcrunch.com/2019/01/20/technologys-dark-forest/
  - Pingback: The Shirk Report – Volume 509 – I Trend Today
    https://www.itrend.today/2019/01/20/the-shirk-report-volume-509/
  - Pingback: Au Courant || WNBTv
    https://willnotbetelevised.com/2019/01/au-courant-222/
  - Pingback: The Route of a Text Message – Dan Q
    https://danq.me/2019/01/17/route-of-a-text-message/
  - Pingback: Things I read in Week 5 of 2019 – Asinine Tech
    https://asininetech.com/2019/02/03/things-i-read-in-week-5-of-2019/
  Chrome stripped: print header (running title + truncated snapshot URL) and
  footer ("N of 35", "4/7/2026, 11:09 AM"); the Wayback banner; the site title
  "the scottbot irregular" and tagline "data are everywhen"; the post title
  (re-emitted as the H1); the byline/category/tag block (-> YAML); the "Related"
  posts widget ([f-s d] Cetus, Down the Rabbit Hole, Barriers to Scholarship &
  Iterative Writing); the comments heading; the Genericons post-author badge
  beside the author's own replies; and the "Proudly powered by WordPress"
  credit.
  Hyperlinks reconstructed from the PDF's link annotations and un-rewritten
  from their /web/<timestamp>/ Wayback form; none guessed. The print sets
  ragged-right text and does not hyphenate at line ends, so all six line-end
  hyphens/dashes are authorial ("140-character", "8- or 16-bit",
  "phone-to-phone", "poly(p-phenylene)", "exciton-polaron", and the em dash in
  "phantom feeling?—and") and were rejoined without a space.
  HARD LINE BREAKS: five printed lines stop far short of the 549-pt right
  margin yet are followed by a normally-spaced line — i.e. the source had a
  <br>, not a wrap. They are restored as Markdown hard breaks (two trailing
  spaces): "Great text. Thx 4 writing." / "Best wishes from Augsburg /
  Germany"; "...frequencies." / "Read the wikipedia articles on TDMA and
  CDMA..."; "Hey Scott!" / "There seems to be a typo..."; and the two breaks in
  the final comment ("I'll wait.”unquote" / "it's figure 3....." / "by the
  way, nice story!"). All five fall in reader comments. Every other short line
  in the print is a genuine wrap and was rejoined.
  Source oddities preserved verbatim, including the arithmetic slip "1,140 / 7
  = 160" (a commenter points it out), "moves more that a certain number of
  pixels", and the commenters' own spelling and punctuation.
...
\[*Note*: Find [the more polished, professionally illustrated version of this piece at Motherboard|Vice](https://motherboard.vice.com/en_us/article/kzdn8n/the-route-of-a-text-message-a-love-story)!\]
...
![Diagram, “Surface Capacitive”: a cross-section of a touchscreen — protective cover, transparent electrode film, glass substrate — with a finger drawing an electric current, and below it a plan view of the screen with electrodes at its four corners](images/img-001.png)
...
![Screenshot of syntax-highlighted Android source code handling MotionEvent.ACTION\_MOVE, with comments about scrolling, the touch slop, and “left as an exercise for the reader”](images/img-002.png)
...
![Table, “The GSM 03.38 character set”: a grid mapping the hex codes 0x00-0x7F to characters, with SP, ESC, LF and CR picked out in red](images/img-003.png)

![Table, “GSM 03.38 Escaped Characters”: the escape sequence and hex code for each of the ten symbols GSM-7 can only reach by escaping — the euro sign, form feed, the square and curly brackets, backslash, caret, vertical bar and tilde](images/img-004.png)
...
![Diagram of the SMS PDU layout as a row of labelled fields — SCA (1-10 octets), PDU-type, MR, DA, PID, DCS, VP, UDL and UD (0-140 octets) — with the PDU-type byte expanded into its bits RP, UDHI, SRR, VPF, RD and MTI](images/img-005.png)
...
![Diagram, “SMS Cellular Network”: two Mobile Devices, each behind a Cell Tower and an MSC, joined through a central SMSC which feeds a GMSC gateway to TCP/IP](images/img-006.png)
...
![Table of PID values and their meanings, from 0x00 “Default - store and forward message” through the telex, telefax, ERMES, videotex and paging entries to 0xC0-0xFF “SC specific use”](images/img-007.png)
...
![Diagram of a sine wave labelled with Peak, Trough, Wavelength and Amplitude](images/img-008.png)
...
![Diagram, “SMS in GSM Networks”: a numbered eight-step route from mobile station MS1 through BTS/BSC, MSC/VLR, SMSC, GMSC and HLR back down to MS2](images/img-009.png)
...
![Diagram of the received-message PDU layout — SCA, PDU-type, OA, PID, DCS, SCTS, UDL and UD — with the PDU-type byte expanded into RP, UDHI, SRI, MMS and MTI](images/img-010.png)
...
![Close-up of an OLED subpixel array: red, green and blue diamonds in a diagonal lattice on black](images/img-011.png)
...
![Exploded diagram of an OLED stack — glass substrate, transparent anode (ITO), hole transport layer (HTL), emitting layer (EML), electron transport layer (ETL) and metal cathode — with a yellow arrow marking the light emission](images/img-012.png)
...
![Black-and-white woodcut in which a flock of dark birds at the top interlocks with pale fish at the bottom, each shape forming the negative space of the other](images/img-013.png)
...
> [**Dillon Nichols**](https://tinkerer.us/), January 16, 2019 at 3:04 pm
>
> This is a great post. Love your writing style and ability to convey complex information. Not only this, but I have a new bakery to try. Might just stop by tonight.

>> **scott b. weingart**, January 16, 2019 at 3:08 pm
>>
>> Thanks! Unfortunately La Gourmandine isn’t open in the evenings. For the most delicious evening baked goods, hit up the Butterwood in Lawrenceville.

> [**Patrick Way (@PatricksData)**](http://twitter.com/PatricksData), January 16, 2019 at 5:49 pm
>
> Thank you for this fantastic article!

> **dandigangi**, January 16, 2019 at 6:28 pm
>
> This was an awesome read. Thanks for the learnings!

> **daniel kepler**, January 16, 2019 at 6:49 pm
>
> Awesome way to explain the complexities of technology through a very human story.

> **Phil**, January 16, 2019 at 9:12 pm
>
> Great text. Thx 4 writing.  
> Best wishes from Augsburg / Germany

> **Maks Brunowich**, January 16, 2019 at 9:21 pm
>
> In short message (SMS) terminology, a PDU is not the name of each individual part inside a communication packet (with a packet being f.e. a submission of a short message, or a delivery report for a short message); it’s the term for the complete packet.

> **Alan**, January 17, 2019 at 12:09 am
>
> Just wanted to say that this is possibly the most elegant piece of technical writing it’s been my pleasure to read. As a technical writer, I am in awe.

> [**ldorigo**](http://gravatar.com/dorigoluca), January 17, 2019 at 6:21 am
>
> This is fascinating, and scary. I wasn’t aware before now that no encryption at all was involved in SMS. From this description it seems uncannily easy to intercept and read all the messages flying around you?

>> **K**, January 17, 2019 at 9:58 pm
>>
>> You need specialized equipment to do so. It isn’t as simple as running tcpdump fortunately

>>> [**ldorigo**](http://gravatar.com/dorigoluca), January 18, 2019 at 10:13 am
>>>
>>> Why? If a phone can receive messages addressed to it, what prevents it (with a bit of hacking) from receiving all the other ones?

>>>> **Paul**, January 22, 2019 at 9:59 pm
>>>>
>>>> Let me guess: proprietary firmware of the radio module?

> **Victoria**, January 17, 2019 at 6:51 am
>
> I am in love with what you wrote. Thank you so much. You and your wife are very lucky to have found eachother. You made it so easy for me to understand. You would be a great teacher to explain things like this to a certain group of folks like my self. Im not sure how to label us. You have what it takes to explain it to where we stay intrigued and can see the picture you paint.

> **Cari**, January 17, 2019 at 10:02 am
>
> U make it a fun read, ez 2 absorb info. I’d be tickled pink if u had a piece on social media, it’s birth to it’s addicts perhaps. Surely a plethora of witty “fun facts” nd “quizzical curiousities” maybe some added “knee slappers” for flare.

> **Don Davis**, January 17, 2019 at 12:47 pm
>
> Great, great read. It’s so rare to gain insight to the inner workings of our everyday tech, AND for it to be clear, humorous, easy to understand and leave you wanting more. My compliments!

> **Hans Bouchard**, January 17, 2019 at 12:52 pm
>
> I will definitely be citing this in my PhD thesis as an illustration of the (medial) transformation process. A minor shortage: Although it is an “informal” text, would it be possible to credit Escher (Sky and Water I) in figure 11. His works are awesome, like yours.

> [**David Allen**](https://scottbot.net/the-route-of-a-text-message/), January 17, 2019 at 2:07 pm
>
> WOW!!!!!! Just when it was safe to go back in the water, whew! This has been the base tech for a long time, I am in my 60’s and it seems I have forgotten much of what I was taught in basic Technology class. In layman’s’ terms this is the shit. I can truly appreciate the simplicity of how you have laid out the routing of such a simple message. Very well put together, Thank you.

> **crosscanadafamily**, January 17, 2019 at 3:49 pm
>
> Granted it is early days but this is my favorite post of 2019. Perfectly written and obsessively interesting!

> **brenthfox**, January 17, 2019 at 4:10 pm
>
> Really great piece. Thank you for putting it together!

> [**Jeppe Utzon**](https://www.jeppeutzon.com/), January 17, 2019 at 4:49 pm
>
> Wonderful read – even if you skipped the part where NSA scanned the message.

> **Stephanie Summers**, January 17, 2019 at 5:30 pm
>
> Wow! Obviously sitting the dark of the unknown of technology. I had no idea how text works and I was totally shocked at all the routes and translations of builded codeing and data it Intels. I had no idea how much was put into this to build such a wonderful service. I am greatful for the smart folks that worked so hard to give us this gift.

> **crosscanadafamily**, January 17, 2019 at 6:42 pm
>
> Not sure of you read this but a question ocurred to me. When cell phones are actually used as originally intended to carry voice, is that digitized in some way? Or is it roughly equivalent to an old style radio transmission at that point? Cheers

>> [**Waider**](http://www.waider.ie/), January 17, 2019 at 11:10 pm
>>
>> It’s encoded digitally with a bunch of clever routines to cope with corruption of the signal during transmission.

>> **Tim G.**, January 22, 2019 at 3:54 am
>>
>> As ORIGINALLY intended? Back in the days of the early cell phones, it WAS an analog radio signal, and you could listen in to calls on a radio if you could tune in the right frequency. Soon they started banning the sale of radio scanners that could receive those frequencies.  
>> Read the wikipedia articles on TDMA and then CDMA to see how that has changed since the late 80’s.

> **K**, January 17, 2019 at 9:56 pm
>
> This is such a fantastic, elegant, and fascinating piece of writing. Thank you for sharing.

> [**Matt Taylor (@mbltaylor)**](http://twitter.com/mbltaylor), January 18, 2019 at 1:21 am
>
> Very well explained. This should be a primer for hackers and CS students. I learnt a good chunk of this back in late 90s when working at a mobile device company – few people really appreciate or understand the phenomenal level of complexity and layers, handoffs, translations and so on that takes content from your thumbs to someone else’s eyeballs. Never mind the biological processes before and after.
>
> Great writing – with a few more topics this would make a great book “How your phone really works” or somesuch.

> [**Rahul Ranjan (@coyotelius)**](http://twitter.com/coyotelius), January 18, 2019 at 3:42 am
>
> Elegant, so detailed. Loved it.

> **moonagirl**, January 18, 2019 at 6:24 am
>
> If it is possible,can say what happened inside the phone(Code or kernel)?

> [**Christoph Hess**](https://plus.google.com/116077032231026086342), January 21, 2019 at 7:57 am
>
> What a beautifully crafted article. And quite a fascinating read also. Thank you and your wife by proxy.

> **Dzidek**, January 29, 2019 at 9:37 am
>
> Fab article! Thank you.

> [**Johannes Ridderstedt**](https://www.46elks.com/docs), January 31, 2019 at 8:30 pm
>
> Hey Scott!  
> There seems to be a typo where 1,140 should be 1,120.

>> **scott b. weingart**, January 31, 2019 at 10:30 pm
>>
>> Good catch, thanks!

> [**Sunil Kumar**](https://www.linkedin.com/in/ssunilkumar/), February 7, 2019 at 12:54 pm
>
> Amazing article !!

> **oscar**, February 27, 2019 at 9:12 pm
>
> Thanks for the great article! I think this part may have transposed the 8-bit and 7-bit descriptions:
>
> “Each two-character code, called a hex code, is one 8-bit \[7?\] chunk, and together it spells “I love you”.
>
> But this is actually not how the message is stored on her phone. It has to convert the 8-bit \[7?\] text to 7-bit \[8?\] hex codes, which it does by essentially borrowing the remaining bit at the end of every byte.”

> [**2011lisa**](http://gravatar.com/2011lisa), February 28, 2019 at 7:48 pm
>
> Scott- you are an angel- absolutely world shattering article that you have written!! FANTASTIC

> **2011lisa**, February 28, 2019 at 7:53 pm
>
> FANTASTIC! WORLD SHATTERING!

> **Jan L**, March 7, 2019 at 2:19 am
>
> I love it! What a masterpiece! This could be further elaborated into a three piece book format. Pulitzer price worthy.

> **Mik**, March 8, 2019 at 11:00 am
>
> Fascinating and captivating. Took me back to college when I would read up on emerging technology.

> **Douglas Woods**, March 16, 2019 at 5:25 pm
>
> Scott, thank you for demonstrating that a highly technical article can be written in a way to make someone laugh out loud (often). It was like you channeled the insight of Michael Pollan and the humor of Doug Adams. I loved it and I have spent my morning annoying my friends and family insisting that they read this article as well. I thank you again, even if they may not.

> **Giorgio Colombo**, March 22, 2019 at 1:40 pm
>
> quote”The validity period (VP) space can take up to seven bytes, and sends us into another aspect of how text messages actually work. Take another look at Figure 4, above. It’s okay, I’ll wait.”unquote  
> it’s figure 3…..  
