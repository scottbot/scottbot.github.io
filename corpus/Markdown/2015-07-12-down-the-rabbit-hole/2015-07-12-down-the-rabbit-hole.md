...
tags: ["scholarly communication", "visualizations"]
...
archive_date: "2015-08-22"
archive_timestamp: "20150822130429"

language: "en"
comments_preserved: true
comment_count: 2

source_pdf: "Weingart - 2015 - Down the Rabbit Hole.pdf"
source_pdf_sha256: "8b76b5d2b97d1a7c974b0b89b85850e41fa7aa9531ddc7ad3b37eb4ed01766e3"
extraction_date: "2026-08-02"
extraction_tool: "claude scholarly-blog-html-to-markdown skill (from Wayback print PDF)"
extraction_notes: |
  Post date confirmed as 2015-07-12 from the Wayback capture of the blog's monthly archive
  page (scottbot.net), which prints the dateline the single-post print omitted.
  Source is a Firefox/cairo browser print-to-PDF (15 pages, printed 4/4/2026)
  of Wayback snapshot 20150822130429 of the scottbot.net/HIAL post
  (Independent Publisher theme). PROVENANCE CAVEATS: (1) the theme printed no
  dateline. Internal evidence dates the post very tightly to 11-12 July 2015 —
  it opens "Tonight Alex Vespignani ... tweeted", the embedded tweet is dated
  July 11, 2015, the post's own recap says "that's a 7/11/2015 tweet, pointing
  to a 7/11/2015 article on Quartz", the appended "edit 2" quotes a July 12,
  2015 tweet, and the first reader comment is July 16, 2015 — but the exact
  publication day (11 or 12 July) cannot be settled offline, so post_date is
  recorded as the bare year and the output folder uses a year-only slug
  (flagged in review notes). (2) The print header truncates the snapshot URL,
  but the post's own reply links ("?p=41397&replytocom=...") and the self-link
  on the closing paragraph give the permalink exactly:
  http://www.scottbot.net/HIAL/?p=41397. archive_url is that permalink under
  ...
  "Write a Comment" heading and its Genericons glyph, the two "Reply to ..."
  links, the commenters' avatar images, the "READERS WHO SHARED THIS" widget
  (links to a JITP round-up and a Nuclear Diner links post), the RELATED
  CONTENT BY TAG cloud (2 tags -> YAML), and the "Independent Publisher
  empowered by WordPress" credit.
  The post embeds a YouTube video (the BBC Hitchhiker's Guide "Beware of the
  Leopard" scene). The print captured only the player's title bar; per the blog
  playbook an iframe is converted to a hyperlink, so it appears as an italic
  "Embedded video:" line linking to
  https://www.youtube.com/watch?v=HNmIQX_ImgM (the Wayback prefix, which used a
  different snapshot timestamp for that asset, was stripped). Two embedded
  tweets (Vespignani 11 July, Weingart 12 July) are rendered as blockquotes in
  the print's italics, with their permalinks kept.
  Images: 7 files at native raster resolution. img-004.png (worldmapper Map of
  Science poster) straddles the p6/p7 page break and the print embedded only
  two crops (903x49 + 903x576), so the file was reassembled by stitching them
  into 903x625. img-007.png (the Kramer gif still) straddles p12/p13, but there
  the print embedded the whole 280x362 raster twice, so one uncropped copy was
  used. img-004 and img-005 keep their hyperlinks to the full-size uploads
  (scimap1.png, exceldata.png). The two commenter avatars were skipped as
  chrome. Captions kept as italic caption paragraphs; the photobucket source
  caption prints its URL across three centred lines, rejoined into one URL.
  Comments: both reader comments preserved verbatim (jasonlotito, 16 July 2015;
  Jean Hewlett, 17 July 2015), rendered as depth-1 blockquotes.
  ...
  verbatim: "Quantz" for Quartz, "large research budges", "friend's Viral
  Texts" in the closing repetition (vs. "friends'" in the opening), the mixed
  quotation marks in `“information age“`, and the all-caps outburst on p11.
...
![Detail of the Viral Texts network map: a dense tangle of coloured arcs linking 19th-century U.S. newspaper titles such as the Anti-slavery bugle (New-Lisbon, Ohio) 1845-1861, Gallipolis journal, Sunbury American and Vermont phoenix](images/img-001.png)
...
You know what *isn’t* quaint or charming? Living in the so-called “[information age](https://en.wikipedia.org/wiki/Information_Age)“, where everything is [intertwingled](https://en.wikipedia.org/wiki/Intertwingularity), with hyperlinks and text costing pretty much zilch, and seeing *the same gorram practices*.
...
> *map of the world’s scientific research [http://t.co/sNaKjCQrfe](http://t.co/sNaKjCQrfe)*
>
> *— alex vespignani (@alexvespi) [July 11, 2015](https://twitter.com/alexvespi/status/619985725661020160)*
...
![Cartogram of the world in which each territory is resized by the number of scientific papers published, so North America, Western Europe and Japan swell and Africa and South America shrink to slivers](images/img-002.png)
...
> *This post originally appeared at [The Conversation](https://theconversation.com/its-time-to-redraw-the-worlds-very-unequal-knowledge-map-44206). Follow @US\_conversation on Twitter. We welcome your comments at ideas@qz.com.*
...
![Screenshot of the worldmapper.org home page with “science” typed into the “Search for a map” box, above the site's blurb and thumbnails of reference maps and animations](images/img-003.png)
...
[![The worldmapper “Science Research” poster (Map 205, SASI Group and Mark Newman, 2006): the scientific-papers cartogram, an explanatory text column, a table of the most prolific publishers of scientific papers per million people, a bar chart of scientific publications by region, and the Dorling epigraph](images/img-004.png)](http://www.scottbot.net/HIAL/wp-content/uploads/2015/07/scimap1.png)
...
*Embedded video: [Hitchhiker's Guide: "Beware of the Leopard"](https://www.youtube.com/watch?v=HNmIQX_ImgM)*
...
[![Screenshot of the worldmapper Excel data file: rows of countries and regions with science-paper counts, every row filled with a different saturated colour, over a background image of the cartogram](images/img-005.png)](http://www.scottbot.net/HIAL/wp-content/uploads/2015/07/exceldata.png)
...
![A pink-and-yellow highlighted box from the NSF Science and Engineering Indicators page, headed “Outputs of S&E Research: Articles and Patents”, noting that worldwide S&E publications captured in the Science Citation Index and Social Sciences Citation Index grew from about 466,000 articles in 1988 to nearly 700,000 in 2003](images/img-006.png)
...
![Animated gif still of Kramer from Seinfeld screaming](images/img-007.png)
...
> *FB/Twitter make it easy to reshare with attribution, which is a great step. An even better step would have it suggest a source when you post*
>
> *— Scott B. Weingart (@scott\_bot) [July 12, 2015](https://twitter.com/scott_bot/status/620223374816616448)*
...
> **jasonlotito**, July 16, 2015
>
> “Blood and bloody ashes.”
>
> Bunch of wool-headed sheep herders if you ask me. =)

> **Jean Hewlett**, July 17, 2015
>
> Thanks for this post. I’m a university librarian. I spend a good deal of time trying to teach students how and when to cite their sources. I frequently hear, “But I included the url! That should be enough!” I’m going to share this post with my colleagues, who will chuckle “We’ve been saying this for years” and with my students, who may possibly read it and grok what I’m trying to teach them.
