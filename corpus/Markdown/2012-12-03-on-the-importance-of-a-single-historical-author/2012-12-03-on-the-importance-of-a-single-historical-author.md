...
original_url: "http://www.scottbot.net/HIAL/?p=25594"
archive_url: "https://web.archive.org/web/20130214005639/http://www.scottbot.net/HIAL/?p=25594"
archive_date: "2013-02-14"
archive_timestamp: "20130214005639"

language: "en"
comments_preserved: false
comment_count: 0

source_pdf: "Weingart - 2012 - On the importance of a single historical author.pdf"
source_pdf_sha256: "e47c34c49e0970bdbe83993d4fff38ad4f06f4a2da7331668431bf03c5fe63a3"
extraction_date: "2026-08-02"
extraction_tool: "claude scholarly-blog-html-to-markdown skill (from Wayback print PDF)"
extraction_notes: |
  Post date confirmed as 2012-12-03 from the Wayback capture of the blog's monthly archive
  ...
  snapshot (timestamp 20130214005639). The print header truncates the
  URL; the permalink ?p=25594 was recovered from the post's footnote link
  annotations and original_url/archive_url rebuilt from it. Print
  header/footer (page title, truncated Wayback URL, "N of 5", print date
  3/27/2026) stripped. The reader view prints no dateline, categories,
  tags, or comments. post_date "2012-12" is inferred (month precision
  only, hence the year-only folder slug): the post image lives under
  wp-content/uploads/2012/12/, the post responds to Ben Schmidt's
  "reading digital sources" post of 2012-11 and continues the
  collaboration exchange of the author's ?p=25401; the snapshot
  (2013-02-14) is the upper bound. FOOTNOTES: the archived page rendered
  the "Notes:" list twice — items 1-6 are byte-identical duplicates of
  items 7-12 (verified programmatically), and the six in-body superscript
  references point at 7-12 only. The duplicated list is treated as a
  rendering artifact: one set of definitions is kept and refs/defs are
  renumbered 7-12 -> 1-6 per the footnote-flattening rule; original
  numbering documented here. Back-link arrows (↩) stripped per playbook.
  The wrapped URL in note 2 ("http:// www.wiley.com/...") rejoined
  without the line-break space. Hyperlinks reconstructed from PDF link
  annotations, Wayback prefix stripped. One image (Eric Fischer's
  locals/tourists map of Paris) extracted at native resolution; its
  hyperlink to the full-size upload is kept; printed caption kept as a
  paragraph and mirrored into alt text. The long Milgram quotation is
  indented in the source and preserved as a blockquote. The bolded Ben
  Schmidt quotation spans the p1/p2 boundary and is merged with a page
  anchor.
bibkey: "weingartImportanceSingleHistorical2012"
---
...
[![Map of Paris with dots representing photos taken and posted on Flickr. Red dots are pictures taken by tourists, blue are by locals, and yellow are unknown. via Eric Fischer.](images/img-001.png)](http://www.scottbot.net/HIAL/wp-content/uploads/2012/12/4671584999_57a872d38e_b1.jpg)
