...
archive_timestamp: "20120721195644"

language: "en"
comments_preserved: false
comment_count: 0

source_pdf: "Weingart - 2012 - More Heavy-Handed Culturomics.pdf"
source_pdf_sha256: "912c292124b6bf3bda710d25d743eafe48674f25e8790b512455cb3c32b05d86"
extraction_date: "2026-08-02"
extraction_tool: "claude scholarly-blog-html-to-markdown skill (from Wayback print PDF)"
extraction_notes: |
  Post date confirmed as 2012-02-27 from the Wayback capture of the blog's monthly archive
  ...
  (timestamp 20120721195644) of the post on the old live scottbot.net
  site. The print header/footer truncates the snapshot URL, so the post
  permalink (an /HIAL/?p=NNNN form) is not recoverable; original_url and
  archive_url are left empty. No dateline, categories, tags, or comments
  are visible in this print view. post_date "2012-02" is inferred: the
  post opens "A few days ago, Gao, Hu, Mao, and Perc posted a preprint"
  (arXiv:1202.5299, February 2012) and both figures live under
  wp-content/uploads/2012/02/. Exact day unknown; folder slug is
  therefore year-only ("2012-...").
  Printed page title "More heavy-handed culturomics » the scottbot
  irregular" reduced to the post title H1 (lowercase as printed).
  Both figures are cropped-to-column rasters hyperlinked to their
  full-size wp-content uploads; links kept; the plain-text lines under
  each figure ("Natural/Social 1-grams from Gao et al. (2012)") are
  kept as caption paragraphs. Hyperlinks reconstructed from PDF link
  annotations with the Wayback /web/<ts>/ prefix stripped. The inline
  bold run in the "In sum, they found..." paragraph and the italic run
  crossing the p3/p4 boundary are preserved. This print introduced no
  end-of-line hyphenations except one at the authorial hyphen of
  "socially-oriented" (hyphen kept).
