...
authors:
  - { family: "Langmead", given: "Alison" }
  - { family: "Otis", given: "Jessica M." }
  - { family: "Warren", given: "Christopher N." }
  - { family: "Weingart", given: "Scott B." }
  - { family: "Zilinksi", given: "Lisa D." }
...
url: "www.euppublishing.com/journal/ijhac"
language: "en"
license: "© Edinburgh University Press 2016"
...
source_pdf: "Langmead et al. - 2016 - Towards Interoperable Network Ontologies for the Digital Humanities.pdf"
source_pdf_sha256: "02b5e2ebdbe964e508e3fdf35fdd2aba147cb74a9694495ef8d7ab80366cebc2"
page_count: 14
extraction_date: "2026-08-01"
extraction_tool: "claude scholarly-pdf-to-markdown skill"
extraction_notes: |
  Digital-native typeset proof PDF (A4, with crop marks), single column, printed
  folios 22-35. Metadata transcribed from the PDF itself (Crossref/network not
  reachable in this environment); DOI and journal line as printed on p. 22. The
  final author's surname is printed 'ZILINKSI' in the byline; transcribed as
  printed (the CV form is 'Zilinski'). Typesetting stamp lines, alternating
  running heads, and centred folios removed; folios kept as HTML-comment page
  anchors marking the end of each printed page. Small-caps section headings
  rendered as uppercase '##' headings. Endnotes 1-22 converted to Markdown
  footnotes at their printed marker positions. Figure 1 cropped from p. 29 at
  220 DPI including its printed border; figure-internal text not separately
  transcribed. Tables 1 and 2 reconstructed as GitHub-flavored Markdown tables;
  the source's visual row grouping (blank bands) is not reproducible in GFM.
  Table 2 (p. 32) and Figure 1 (p. 29) sit above paragraphs continuing from the
  previous page and were repositioned after the continuing paragraph so no
  sentence is split. All five line-end hyphens in the source are true compounds
  and were joined with the hyphen retained. The roman 'C' opening the italic
  'Circulation of Knowledge' on p. 23 reproduces the source typesetting. The
  phrase 'we the might map' (p. 31) and 'until in the 1920s' (p. 26) are as
  printed. Ligatures normalized to letter pairs. MANIFEST.txt included.
