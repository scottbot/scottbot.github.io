...
archive_date: "2016-12-30"
archive_timestamp: "20161230100021"

language: "en"
comments_preserved: true
comment_count: 2

source_pdf: "Weingart - 2016 - Acceptances to DH2016 (pt. 1).pdf"
source_pdf_sha256: "0067c3e3a704ff05d7921eba12f04285032021ff43f9d406ae63d2d8b0296944"
extraction_date: "2026-08-01"
extraction_tool: "claude scholarly-blog-html-to-markdown skill (from Wayback print PDF)"
extraction_notes: |
  Converted from a browser print-to-PDF of the Wayback Machine snapshot
  (20161230100021) of the live post. Print header/footer (page title, Wayback
  URL, page numbers, print date 4/5/2026) and Wayback banner stripped, along
  with WordPress chrome (site nav, "Related" widget, post meta line, Leave a
  Reply form, post navigation, author card, Recent Posts, archives, tag cloud,
  footer). Post date, categories and tags taken from the printed post meta
  line ("Posted on March 22, 2016"). Hyperlinks reconstructed from PDF link
  annotations, Wayback /web/<ts>/ prefixes stripped. Images: 3 charts embedded
  in the PDF extracted at native print resolution; each was hyperlinked to its
  full-size wp-content upload, links preserved. Avatar/gravatar images skipped
  as chrome. Comments: 2 reader comments preserved verbatim (nested reply
  indented); 1 pingback ("DHBenelux submissions 2014-2016 | Max Kemman")
  stripped per chrome policy. Page anchors mark print-page boundaries.
  "~~steal~~" restored as strikethrough (rendered struck-through in the
  print; the PDF text layer cannot encode it).
...
[![Number of conference presentations since 2000.](images/img-001.png)](https://i2.wp.com/scottbot.net/wp-content/uploads/2016/03/confpresentations2016.png)
...
[![Proportion of acceptances by type, 2016.](images/img-002.png)](https://i0.wp.com/scottbot.net/wp-content/uploads/2016/03/subtype.png)
...
[![Acceptance rate by number of authors.](images/img-003.png)](https://i0.wp.com/scottbot.net/wp-content/uploads/2016/03/acceptancerate2016.png)
