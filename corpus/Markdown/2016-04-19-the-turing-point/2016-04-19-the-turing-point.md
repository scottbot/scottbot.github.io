...
post_date: "2016-04-19"
post_date_visible: "April 19, 2016"
...
tags: ["ABMs", "appreciability", "bots", "complexity", "human dynamics", "social networks"]
...
archive_date: "2016-07-01"
archive_timestamp: "20160701114921"

language: "en"
comments_preserved: false
comment_count: 0

source_pdf: "Weingart - 2016 - The Turing Point.pdf"
source_pdf_sha256: "93e42441455864df7004278791c2d7d3e00bc2c32715c50a927766071d18e53f"
extraction_date: "2026-08-02"
extraction_tool: "claude scholarly-blog-html-to-markdown skill (from Wayback print PDF)"
extraction_notes: |
  Source is a browser print-to-PDF (8 pages, printed 4/5/2026) of the
  Wayback snapshot 20160701114921 of scottbot.net/the-turing-point/.
  Print header/footer, Wayback banner, masthead/tagline, empty "Related"
  heading, byline block (-> YAML), and site footer stripped as chrome.
  Post date, category, tags, and permalink from the printed p7 byline
  ("scott b. weingart / April 19, 2016 / miscellanea / ABMs,
  appreciability, bots, complexity, human dynamics, social networks").
  Ligature control chars restored per font (\x01=fi italic; \x02=fi,
  \x03=ff, \x04=fl, \x05=ffi regular); non-breaking spaces -> spaces.
  Images: 1 content image (uncanny-valley graph, full 461x360 raster
  embedded on p1; its p2 re-embed is the page-break duplicate). Italic
  CC-attribution caption kept below with links. Three embedded tweets
  (Enderle, Weingart reply, Hart-Davidson) rendered as blockquotes with
  attribution lines, italics as printed. Two footnotes ("Notes:" block)
  -> Markdown footnote syntax, back-arrows stripped; the shrug kaomoji
  in note 1 is backslash-escaped to keep its underscores literal.
  Paragraphs crossing print pages (p2/3, p3/4, p4/5 within a list item,
  p6/7) joined with inline page anchors; the p2/p3 join preserves the
  authorial hyphen in "non-native" with the anchor moved to the next
  word boundary. Line-end hyphens are authorial compounds (non-native,
  well-grounded, human-appreciable); no soft hyphenation. Comments: the
  snapshot's only response is a pingback (Editors' Choice, DH Now),
  stripped per pingback policy; no reader comments (0 preserved).
