...
post_date: "2012-03-01"
post_date_visible: "Mar 01 2012"
...
original_url: ""
archive_url: "https://web.archive.org/web/20120721201259/http://www.scottbot.net/HIAL/"
archive_date: "2012-07-21"
archive_timestamp: "20120721201259"

language: "en"
comments_preserved: false
comment_count: 0

source_pdf: "Weingart - 2012 - The Internet Listens.pdf"
source_pdf_sha256: "0c4c6331dcac7b385bbda92d394078424734791b41a8562b586a5ca9ae9b2044"
extraction_date: "2026-08-02"
extraction_tool: "claude scholarly-blog-html-to-markdown skill (from Wayback print PDF)"
extraction_notes: |
  Source is a Firefox print-to-PDF of a Wayback Machine snapshot
  (timestamp 20120721201259). Print header/footer (page title, Wayback URL,
  page numbers, print date 3/27/2026) stripped. The print header truncated the
  snapshot URL ("http://www.scottbot.net..."), so the exact original permalink
  (an /HIAL/?p=NNNN form) is unrecoverable from this PDF; original_url left
  empty and archive_url records the truncated prefix's site root only.
  Printed page title "The Internet Listens >> the scottbot irregular" includes
  the site name; H1 reduced to the post title. Dateline printed as "Mar 012012"
  (theme glued day/year); post_date 2012-03-01. Hyperlinks reconstructed from
  PDF link annotations with the Wayback /web/<ts>/ prefix stripped. One image
  (Download The Universe banner) extracted at native resolution; it was
  hyperlinked to the full-size upload (dtu.png) and that hyperlink is kept.
  No categories/tags/comments were present in this print view.
bibkey: "weingartInternetListens2012"
---
...
[![Download The Universe banner](images/img-001.png)](http://www.scottbot.net/HIAL/wp-content/uploads/2012/03/dtu.png)
