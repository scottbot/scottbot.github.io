...
archive_date: "2012-05-27"
archive_timestamp: "20120527120032"

language: "en"
comments_preserved: false
comment_count: 0

source_pdf: "Weingart - 2012 - ORBIS The next step in Digital Humanities.pdf"
source_pdf_sha256: "947202e394ddbe2cd787550584a271d2340c4d114377e3c83247fa98db85f8e1"
extraction_date: "2026-08-02"
extraction_tool: "claude scholarly-blog-html-to-markdown skill (from Wayback print PDF)"
extraction_notes: |
  Post date confirmed as 2012-05-02 from the Wayback capture of the blog's monthly archive
  page (scottbot.net), which prints the dateline the single-post print omitted.
  Source is a browser print-to-PDF (reader view) of the Wayback Machine
  snapshot 20120527120032 of http://www.scottbot.net/HIAL/?p=15585 (URL taken
  from the print header, which shows it in full). Print header/footer
  (page title, Wayback URL, "N of 5", print date 3/27/2026) stripped.
  The reader view prints no dateline, categories, tags, or comments, so
  none are preserved here. post_date "2012-05" is inferred (month
  precision only, hence the year-only folder slug): the snapshot is
  2012-05-27, both post images live under wp-content/uploads/2012/04/,
  the post links a Ted Underwood piece of 2012-04-07, and it reviews the
  publicly launched ORBIS site, which went public in early May 2012.
  Hyperlinks reconstructed from PDF link annotations with the Wayback
  /web/<ts>/ prefix stripped. Four images extracted at native resolution;
  each was hyperlinked to its full-size wp-content upload and those
  hyperlinks are kept. Image caption lines are preserved as paragraphs
  below each image (as printed) and duplicated into alt text.
