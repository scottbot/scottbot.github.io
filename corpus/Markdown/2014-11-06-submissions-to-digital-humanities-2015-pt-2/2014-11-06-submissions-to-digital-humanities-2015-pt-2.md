...
tags: ["data analysis", "dhconf", "digital humanities", "scholarly communication", "scientonomy", "text analysis", "visualizations"]

original_url: "http://www.scottbot.net/HIAL/"
archive_url: ""
archive_date: "2015-04-25"
archive_timestamp: "20150425232705"

language: "en"
comments_preserved: false
comment_count: 0

source_pdf: "Weingart - 2014 - Submissions to Digital Humanities 2015 (pt. 2).pdf"
source_pdf_sha256: "59c4bac08e999024d23c375ae25eb748193011d6f6a16cec031c086b39a41b63"
extraction_date: "2026-08-02"
extraction_tool: "claude scholarly-blog-html-to-markdown skill (from Wayback print PDF)"
extraction_notes: |
  Post date confirmed as 2014-11-06 from the Wayback capture of the blog's monthly archive
  page (scottbot.net), which prints the dateline the single-post print omitted.
  Source is a browser print (2026-04-04) of Wayback snapshot 20150425232705
  of the scottbot.net/HIAL post. PROVENANCE CAVEATS: (1) the theme printed
  no dateline. The post follows "Submissions to Digital Humanities 2015
  (pt. 1)" (published on/around November 6, 2014, per its same-day
  comments), replies to a comment on that post, cites Jacqueline
  Wernimont's tweet of November 6, 2014 as "just pointed out", and its
  chart lives in wp-content/uploads/2014/11 — so this post is from early-to-
  mid November 2014; the exact day is undeterminable offline. post_date is
  the bare year and the folder uses a year-only slug, flagged in review
  notes. (2) No comments were printed, so no reply-permalink reveals the
  post's ?p= id (the print header truncates the snapshot URL): original_url
  records the blog root, archive_url is left empty, archive_timestamp is
  exact.
  Print header/footer, Wayback banner, "Write a Comment" heading, the
  RELATED CONTENT BY TAG cloud (moved to YAML), and the theme footer credit
  stripped as chrome. Category "personal research" (?cat=57).
  Images: 5 files. img-001 is the theme's featured-image banner, a
  near-duplicate raster (350x288) of the in-body authors-per-paper chart
  (img-003, 352x290) — kept as separate files since the rasters differ.
  img-004 (topical coverage change) printed across pages 4-6; the complete
  589x1728 raster is embedded on each page and was extracted once; it keeps
  its hyperlink to the full-size dh-topicalchange-2015.png upload (the only
  hyperlinked image in this print). Multi-line captions (the DH-by-volume
  caption runs across the p2/p3 break) reassembled and kept as italic
  caption paragraphs.
  ...
  guessed. Source typos preserved (e.g. "in Switzerland and the Nebraska.",
  "how they they tag their submissions", "This chart shows the that ~40%",
  "this was of our humanistic disciplinary roots", "its too soon to say",
  "the status is pretty quo").
bibkey: "weingartSubmissionsDigitalHumanities2014a"
---
...
![Line chart: # of authors per paper, 2013–2015 (post featured image)](images/img-001.png)
...
![DH by volume, 1999–2014: DHSI workshops per year and DH conference presentations per year](images/img-002.png)
...
Replying to my most recent post, [Jordan T. T-H commented on his surprise](http://www.scottbot.net/HIAL/?p=41041#comment-6861) at how many single-authored works were submitted to the conference. I suggested this was of our humanistic disciplinary roots, and that further analysis would likely reveal a trend of increasing co-authorship. My prediction was wrong: at least over the last three years, co-authorship numbers have been stagnant.

![Line chart: # of authors per paper, showing ~40% of submissions single-authored in 2013–2015](images/img-003.png)
...
[![Topical coverage change since 2013 for each submission topic](images/img-004.png)](http://www.scottbot.net/HIAL/wp-content/uploads/2014/11/dh-topicalchange-2015.png)
...
![Gender ratio of authors at DH conferences 2010–2013](images/img-005.png)
