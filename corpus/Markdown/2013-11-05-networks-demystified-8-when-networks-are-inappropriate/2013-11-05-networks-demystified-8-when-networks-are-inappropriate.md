...
categories: ["method"]
tags: ["complexity", "data analysis", "diffusion", "digital humanities", "methodological critique", "methodologies", "network analysis", "networks demystified", "social networks", "visualizations"]
...
archive_date: "2013-11-30"
archive_timestamp: "20131130120853"

language: "en"
comments_preserved: true
comment_count: 2

source_pdf: "Weingart - 2013 - Networks Demystified 8 When Networks are Inappropriate.pdf"
source_pdf_sha256: "5f866f09a5065105771334d396503169a9bfb485731b1ce0cc518fa800be61cc"
extraction_date: "2026-08-02"
extraction_tool: "claude scholarly-blog-html-to-markdown skill (from Wayback print PDF)"
extraction_notes: |
  Source is a Firefox print-to-PDF (9 pages, printed 3/31/2026) of the
  Wayback snapshot 20131130120853; the page-1 Wayback banner carries the
  full URL (http://www.scottbot.net:80/HIAL/?p=39600; the :80 port is
  dropped in original_url, and the ?p=39600 id is confirmed by the print's
  own REPLY links). This theme prints a right sidebar (author bio, tag
  cloud, recent posts, month selector, scottbot travels photo widget,
  Blurblog shares, blogroll, social icons) interleaved with the body
  column; all sidebar content, the site header/nav/footer, the "5 / 11
  2013" date badge (-> post_date), the "SCOTT WEINGART | METHOD | 2" meta
  line (-> category, comment_count), the post-footer tag line (-> tags),
  the "SUBMISSIONS TO DIGITAL HUMANITIES 2014" next-post link, the "2
  thoughts on ..." comment-count heading, REPLY links, and the "Leave a
  Reply" comment form are chrome and were stripped. The body font prints
  fi/fl ligature glyphs; normalized to plain letters. Three figures
  extracted from embedded rasters at native resolution (586x252,
  1929x1206, 1146x809); each is hyperlinked to its full-size upload
  (hyperlinks kept, Wayback prefixes stripped) and its caption (roman in
  this print) kept with the literal "[via]" brackets escaped. Sidebar photo thumbnails and
  comment avatars were not extracted (chrome). Paragraphs straddling the
  p3/p4, p4/p5, and p6/p7 print breaks joined with anchors kept inline; a
  line break after "assistance/" reversed without adding a space. Both
  reader comments (2) preserved verbatim with author links and dated
  headers. Source typos kept verbatim (e.g. "map of of the DH2011
  conference", "only to find out that later that", "answer at questions",
  "in way that stands out"). The hyphen in "re-aligned" is the source's
  own (ragged-right print, no auto-hyphenation).
bibkey: "weingartNetworksDemystified82013"
---

# Networks Demystified 8: When Networks are Inappropriate

A few hundred years ago, I promised to talk about when not to use networks, or when networks are used improperly. With [The Historian’s Macroscope](http://themacroscope.org/) in the works, I’ve decided to finally start answering that question, and this Networks Demystified is my first attempt at doing so. If you’re new here, this is part of an annoyingly long series ([1](http://www.scottbot.net/HIAL/?p=6279) network basics, [2](http://www.scottbot.net/HIAL/?p=6526) degree, [3](http://www.scottbot.net/HIAL/?p=17824) power laws, [4](http://www.scottbot.net/HIAL/?p=38272) co-citation analysis, [5](http://www.scottbot.net/HIAL/?p=39344) communities and PageRank, 6 this space left intentionally blank, [7](http://www.scottbot.net/HIAL/?p=39432) co-citation analysis II). I’ve issued a lot of vague words of caution without doing a great job of explaining them, so here is the first substantive part of that explanation.
