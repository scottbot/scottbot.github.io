...
tags: ["archives", "full-stack dev", "history of science", "republic of letters", "scholarly communication"]
series: "full-stack dev (f-s d)"

original_url: "https://scottbot.net/cetus/"
archive_url: "https://web.archive.org/web/20190126100333/https://scottbot.net/cetus/"
archive_date: "2019-01-26"
archive_timestamp: "20190126100333"
...
source_html: "_f-s_d__Cetus___the_scottbot_irregular.htm"
source_html_sha256: "0754b4639559305b2fb4d397980987654f7b83ce740c7212c6b36c0fcdbadaa5"
extraction_date: "2026-05-09"
extraction_tool: "claude scholarly-blog-html-to-markdown skill"
extraction_notes: |
  Converted from a Wayback Machine snapshot (2019-01-26) of the post
  originally published 2016-06-16 on scottbot.net. Wayback toolbar,
  injected scripts, and rewritten URLs were stripped; outbound hyperlinks
  point at the original (un-rewritten) URLs. WordPress chrome (sharing
  widgets, Jetpack related-posts, navigation, comment form, sidebar)
  removed. Two embedded Twitter blockquotes that lived in the post body
  have been preserved as block quotes attributing the tweet authors with
  the original tweet URLs as hyperlinks; the live <twitter-widget>
  rendering harness has been removed. All eight body images were
  supplied by the user as local files; the largest available version of
  each was copied into images/ and references rewritten to local paths.
  The Hevelius spreadsheet figure appears twice in the original post
  (once near the top as a teaser, once again under "Spreadsheet Errors")
  and is preserved in both locations. No reader comments existed in the
  archived snapshot — only the (now stripped) reply form.
...
I promised this series will be about the secret life of data, answering the question of what's behind a spreadsheet. *Cetus* is only the first story (well, [second](http://scottbot.net/down-the-rabbit-hole/), I guess), but the idea is to upturn the iceberg underlying seemingly mundane datasets to reveal the complicated stories of their creation and usage. Stay-tuned for future installments.

## Notes

[^1]: I'm retroactively adding [my blog rant about data underlying an equality visualization](http://scottbot.net/down-the-rabbit-hole/) to the *f-s d* series.
