...
# --- categorization ---
categories: ["method"]
tags: ["bayesian", "big data", "digital humanities", "methodologies", "statistics"]
...
archive_date: "2012-12-02"
archive_timestamp: "20121202161527"

# --- descriptive ---
description: |
  A few months ago, Science published a Thanksgiving article on what scientists can be grateful for. It’s got a lot of good points, like being thankful for family members who accept the crazy h...
language: "en"
...
# --- provenance ---
source_html: "Doing_Bayesian_Data_Analysis___the_scottbot_irregular.htm"
source_html_sha256: "a53342c5196161be521ddbc40836b8ae4f3b8d4667322c9b4efd3f49047fb178"
extraction_date: "2026-05-20"
extraction_tool: "claude scholarly-blog-html-to-markdown skill"
extraction_notes: |
  Wayback Machine toolbar and injected scripts stripped. Post body taken from div.post-8237 > div.post-bodycopy. Author inferred from blog ownership ('the scottbot irregular' is the personal blog of Scott B. Weingart) and confirmed by author replies within the comment thread. All 4 inline body images were supplied as separate uploads and copied into images/ (no network fetch was attempted). 6 of 7 reader comments preserved (the H1 comment-bubble badge showed '7'; the parsed list contains 6, the difference likely accounted for by trackbacks or pingbacks not preserved in this snapshot).
...
the caveats in my [first Networks Demystified](http://www.scottbot.net/HIAL/?p=6279) post apply here: don’t use it without fully understanding it, and changing it where necessary.
