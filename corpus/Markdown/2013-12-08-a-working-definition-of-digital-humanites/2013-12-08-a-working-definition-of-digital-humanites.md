...
archive_date: "2013-12-09"
archive_timestamp: "20131209014123"

language: "en"
comments_preserved: true
comment_count: 0

source_pdf: "Weingart - 2013 - A Working Definition of Digital Humanites.pdf"
source_pdf_sha256: "ac135ea19156fdf39fb5367a31f741f2dbe29d63d1986e99dfdb629d0f21ce2e"
extraction_date: "2026-08-02"
extraction_tool: "claude scholarly-blog-html-to-markdown skill (from Wayback print PDF)"
extraction_notes: |
  Source is a Firefox print-to-PDF (6 pages, printed 3/31/2026) of the
  Wayback snapshot 20131209014123. Print header/footer stripped. The title's
  "Humanites" spelling is the post's own typo, kept verbatim (also in the
  slug). Dateline printed "8 12 2013" (day month year; snapshot taken
  2013-12-09) -> post_date 2013-12-08. Meta line "Scott Weingart |
  miscellanea | 0" and the tag line "digital humanities, methodologies,
  pedagogy" feed YAML (category link ?cat=61; the comment counter "0" links
  to ?p=39749#respond, which supplies original_url; no comments existed).
  Paige Morgan's embedded tweet rendered as a blockquote with attribution.
  The survey email and each reply quoted as blockquotes; multi-paragraph
  replies kept as one quote with paragraph breaks; the email sign-off "Many
  thanks,/Scott" keeps its line break. Ted Underwood's reply contains a
  numbered list and a bulleted list inside the quote (printed bullets ->
  "-"). Strikethrough on "ALLC" (visible in the rendered page, not encodable
  in the PDF text layer) restored as ~~ALLC~~. The Terras quote paragraph
  "As with all of these things..." straddles the p4/p5 print break and is
  joined. A 19x16 wp-smiley emoticon image after "just sayin'." is WordPress
  chrome and was NOT extracted (noted here per playbook). Literal asterisks
  in "*interest* and the *passion*" are the source's own characters, escaped
  in Markdown. One image extracted at native resolution (1026x1026
  curriculumbooks1); it was hyperlinked to its full-size upload and the
  hyperlink is kept. Hyperlinks reconstructed from PDF link annotations with
  Wayback prefixes stripped.
...
Instead, I’m here to report the findings of an extremely informal survey, with a sample size of 5, inspired by [Paige Morgan’s question](https://twitter.com/paigecmorgan/status/403178143927644160) of what courses an undergraduate interested in digital humanities should take:

> Should undergrads w/ humanities majors & interest in [#digitalhumanities](https://twitter.com/search?q=%23digitalhumanities&src=hash) grad work pursue a second CS major, or a CS minor?
>
> — Paige Morgan (@paigecmorgan) [November 20, 2013](https://twitter.com/paigecmorgan/statuses/403178143927644160)
...
[![The Pipe Dream Curriculum: a figure carrying a stack of textbooks](images/img-001.png)](http://www.scottbot.net/HIAL/wp-content/uploads/2013/12/curriculumbooks1.jpg)

<!-- page 1 -->

The Pipe Dream Curriculum. [[via](http://www.underthegoldenappletree.com/2012/04/six-things-to-consider-when-choosing.html)]
...
The first reply was from [Ted Underwood](http://tedunderwood.com/), who was afraid my question skirted a bit too close to defining DH, saying:
...
While Underwood is pretty well known for his computational literary history, [Johanna Drucker](http://gseis.ucla.edu/people/drucker) is probably most well known in our circles for her work in DH criticism. Her reply was concise and helpful:

> Look at [http://dh101.humanities.ucla.edu](http://dh101.humanities.ucla.edu/)
>
...
The next reply came from [Melissa Terras](http://melissaterras.blogspot.com/), the director of the DH center (I’m sorry, *centre*) at UCL. Her response was a bit more general:
...
[John Walsh](http://ils.indiana.edu/faculty/jawalsh/) is known in the DH world for his work on TEI, XML, and other formal data models of humanities media. He replied:
...
[Matt Jockers](http://www.matthewjockers.net/)‘ expertise, like Underwoods, tends toward computational literary history and criticism. His reply was short and to the point:
...
Jockers, like Underwood, mentioned that I was missing linguistics. On the twitter conversation, [Heather Froehlich](http://hfroehlich.wordpress.com/) pointed out the same deficiency. He and Underwood also pointed out machine learning, which are particularly useful for the sort of research they both do.
