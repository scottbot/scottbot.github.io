...
categories: ["reviews"]
tags: ["data analysis", "digital humanities", "methodologies", "text analysis"]
...
archive_date: "2015-10-22"
archive_timestamp: "20151022195215"

language: "en"
comments_preserved: true
comment_count: 4

source_pdf: "Weingart - 2012 - In Defense of Collaboration.pdf"
source_pdf_sha256: "fa8067641e4a344ddd7de37e5adb2a0f4997889bc38d0f1d7130d1bb6beca83d"
extraction_date: "2026-08-02"
extraction_tool: "claude scholarly-blog-html-to-markdown skill (from Wayback print PDF)"
extraction_notes: |
  Post date confirmed as 2012-11-17 from the Wayback capture of the blog's monthly archive
  ...
  (timestamp 20151022195215) of the live scottbot.net/HIAL site
  ("Independent Publisher" theme). The print header truncates the page
  URL, but the post id is recoverable from the comment-reply link
  annotations (?p=25401&replytocom=...), so original_url/archive_url use
  the ?p=25401 permalink. No dateline is printed by this theme.
  post_date "2012-11" is inferred: all four post images live under
  wp-content/uploads/2012/11/ and all four reader comments are dated
  November 17, 2012. Exact day unknown; folder slug is year-only.
  The italic lede ("Being a very round-about review...") is post content
  and kept as the opening paragraph. Print chrome, the Wayback banner,
  the "Write a Comment" form links, "Reply to ..." links, avatars, the
  RELATED CONTENT BY TAG widget (fed into YAML tags), and the theme
  footer were stripped; the category line "in reviews" feeds YAML
  categories. 4 reader comments preserved verbatim (flat thread) with
  visible dates; commenter names keep their profile links. Literal
  asterisks typed by commenters (e.g. "collaborationist*", "*One way
  to solve the kitten problem...", "*turns out to be*") are escaped
  as \* so they render as typed. Hyperlinks reconstructed from PDF
  link annotations with the Wayback /web/<ts>/ prefix stripped.
  End-of-line hyphenations introduced by print justification were
  rejoined; authorial hyphens kept in "dual-competencies" and
  "mega-centers" (see review notes). A line wrapped at a slash was
  rejoined ("division-of-labor/collaboration").
...
[![Left brain / right brain illustration](images/img-001.png)](http://www.scottbot.net/HIAL/wp-content/uploads/2012/11/left-right-brain-570x3661.png)
...
[![Athena springing fully formed from Zeus's forehead](images/img-002.png)](http://www.scottbot.net/HIAL/wp-content/uploads/2012/11/birth-from-headbig1.jpg)
...
[![Copiale cipher manuscript page](images/img-003.png)](http://www.scottbot.net/HIAL/wp-content/uploads/2012/11/decipher1a1.jpg)
...
[![Mr. Penumbra's 24-Hour Bookstore cover](images/img-004.png)](http://www.scottbot.net/HIAL/wp-content/uploads/2012/11/penumbra-cover-flip-light-3201.jpg)
