---
title: "Notice of Funding Opportunity — State and Impact of the Humanities"
subtitle: ""
authors: []
corporate_author: "National Endowment for the Humanities, Office of Data and Evaluation"

publication_type: "report"
document_type: "Notice of Funding Opportunity (NOFO)"
publisher: "National Endowment for the Humanities"
publisher_place: "Washington, DC"
issuing_office: "Office of Data and Evaluation"

funding_opportunity_number: "20250416-XO"
funding_opportunity_type: "New"
federal_assistance_listing_number: "45.159"
omb_control_number: "3136-0134"
omb_expiration_date: "2027-10-31"
optional_draft_deadline: "2025-02-14"
application_deadline: "2025-04-16"
...
doi: ""
isbn: ""
url: "https://www.neh.gov/program/state-and-impact-humanities"
contact_email: "odeprograms@neh.gov"

abstract: |
  The National Endowment for the Humanities (NEH) Office of Data and Evaluation is accepting
  applications for the State and Impact of the Humanities program. This program supports
  data-grounded research studies that investigate the state, impact, and value of the
  humanities in the United States. Research designs may be quantitative, qualitative, or
  mixed, and should involve the active participation of people working in the humanities.
keywords: []
language: "en"
license: ""

source_pdf: "SOH-NOFO-2025.pdf"
source_pdf_sha256: "f43ed4685976d7706b5e21666cbe0d1cdacd33198847c3de72f064b766996b29"
page_count: 40
extraction_date: "2026-08-02"
extraction_tool: "claude scholarly-pdf-to-markdown skill"
extraction_notes: |
  publication_type is "report" (administrative/policy document, not a scholarly publication).
  This is a U.S. federal Notice of Funding Opportunity issued by the NEH Office of Data and
  Evaluation; no personal byline is printed, so the issuing agency and office are recorded as
  the corporate author and `authors` is empty. Metadata comes from the document itself and from
  the PDF's own document properties; no network or Crossref lookup was available.

  Word-derived PDF (Acrobat PDFMaker 24 for Word / Adobe PDF Library 24.5.96), 40 pages,
  single column, Arial throughout. Paragraph boundaries were reconstructed from the empty
  spacer lines Word emits between paragraphs, and heading levels from the PDF's own document
  outline (144 bookmark entries, five levels), so the printed hierarchy is preserved exactly:
  outline level 1-5 maps to Markdown `##` through `######`. All 144 outline headings were
  located in the page text and matched one-to-one; headings that wrap onto a second printed
  line were re-joined. The cover's program title carries the document's single `#`.

  ALL headings, numbered and lettered lists, bulleted lists, eligibility criteria, deadlines,
  dollar amounts, page limits, file names and form-field instructions are reproduced verbatim.
  Bulleted lists use the Symbol-font bullet in the source and are rendered as `-` items;
  numbered lists that are set with a hanging indent are rendered as ordered list items with
  their printed numbers. Labels that the source sets flush to the body margin without a
  hanging indent (for example "a-d.", "e-f.", "g." on printed page 15 and "1. Materials and
  Supplies" through "8. Other Costs" on printed page 26) are kept as ordinary paragraphs,
  matching the printed layout rather than imposing list structure the document does not use.

  The printed Table of Contents (PDF page 3) is reformatted as a two-level bullet list with
  leader dots stripped and the printed page number kept after an em dash; its entries remain
  live cross-reference links.

  Tables: the four real tables (the Executive Summary table on printed page i, the
  Output/Outcome table on printed page 4, and the two-page Application Component Table on
  printed pages 9-10) are reconstructed as GitHub-flavored Markdown tables. None was
  rasterized and none was dropped. Cells that hold several distinct lines or a bulleted list
  use `<br>` line breaks inside the cell, which is the only HTML used anywhere in the output;
  a wrapped sentence inside a cell is joined with a space instead. Full-width spanning rows
  ("Attachments", "Grants.gov forms") appear as a row whose first cell holds the label and
  whose remaining cells are empty, as printed. An automatic table detector also proposed
  tables on printed pages 4, 8, 15, 17 and 18; those were inspected against the rendered
  pages, found to be false positives caused by hyperlink underlines, and rejected, so no
  prose was absorbed into a table.

  Hyperlinks: 221 external link annotations are reconstructed as Markdown links with the
  exact target recorded in the PDF. The 110 internal cross-reference links are resolved
  through the PDF's own outline destinations to in-document anchors (`#slug` of the target
  heading), so "See C. Eligibility Information" and similar references remain navigable.
  Link text that is itself a URL and wraps across two printed lines is rejoined without the
  inserted space.

  Line-final hyphens are genuine compound hyphens: Word wraps after an existing hyphen and
  never hyphenates, so every one was kept and the lines joined without a space (verified
  against all 14 occurrences). Smart quotes, section signs, en dashes, the ellipsis and the
  vulgar fraction are preserved as printed; a narrow no-break space was normalized to a
  regular space. The running footer (the funding opportunity number and the printed folio)
  was removed; folios survive as page anchors, with PDF page 1 anchored as `cover` since it
  carries no folio and PDF pages 2-3 anchored as the printed `i` and `ii`.

  The red warning text on the cover and the purple visited-link colour on printed page i are
  colour only; the words are reproduced but the colours are not, since Markdown has no
  faithful equivalent. The NEH logo on the cover is the document's only image and is extracted
  to images/fig-001.png. There are no figures, footnotes, endnotes, equations, or bibliography
  in this document. MANIFEST.txt included.
bibkey: "StateImpactHumanities"
---

![Logo: a rising-sun device above the wordmark NATIONAL ENDOWMENT FOR THE HUMANITIES.](images/fig-001.png)
...
| Award Amounts | Level 1: Up to $75,000<br>Level 2: Up to $150,000 |
| Cost Sharing/Match Required | No |
| Period of Performance | Level 1: Up to 12 months<br>Level 2: Up to 24 months<br>Projects must start between February 1, 2026, and April 1, 2026. |
| Eligible Applicants | - nonprofit organizations recognized as tax-exempt under section 501(c)(3) of the Internal Revenue Code<br>- accredited institutions of higher education (public or nonprofit)<br>- state and local governments and their agencies<br>- federally recognized Native American Tribal governments<br>See [C. Eligibility Information](#c-eligibility-information) for additional information. |
| Program Resource Page | [https://www.neh.gov/program/state-and-impact-humanities](https://www.neh.gov/program/state-and-impact-humanities) |
| Pre-Application Webinar | A prerecorded webinar is available at:<br>[https://www.youtube.com/watch?v=x-V0DvoWnhY](https://gcc02.safelinks.protection.outlook.com/?url=https%3A%2F%2Fwww.youtube.com%2Fwatch%3Fv%3Dx-V0DvoWnhY&data=05%7C02%7Cjingram%40neh.gov%7C6a9d7da26d7a499fb9f008dd364b1a0a%7C93b06459c77d44b6af7fe813cddcdcc3%7C0%7C0%7C638726418361494315%7CUnknown%7CTWFpbGZsb3d8eyJFbXB0eU1hcGkiOnRydWUsIlYiOiIwLjAuMDAwMCIsIlAiOiJXaW4zMiIsIkFOIjoiTWFpbCIsIldUIjoyfQ%3D%3D%7C0%7C%7C%7C&sdata=HR5L24BMv%2FGro%2BoJcdk9Jx1iforVrkCCC9IKDtPESl0%3D&reserved=0)<br>A live Q&A session will be held on February 4, 2025, at 2pm Eastern.<br>[State and Impact of the Humanities Q&A](https://gcc02.safelinks.protection.outlook.com/?url=https%3A%2F%2Fevents.gcc.teams.microsoft.com%2Fevent%2Fa9d141b4-f5da-4e9b-80ff-ef78fdf04257%4093b06459-c77d-44b6-af7f-e813cddcdcc3&data=05%7C02%7Cjingram%40neh.gov%7Cdf226e4031e343c8dd8d08dd36532e6d%7C93b06459c77d44b6af7fe813cddcdcc3%7C0%7C0%7C638726453073707842%7CUnknown%7CTWFpbGZsb3d8eyJFbXB0eU1hcGkiOnRydWUsIlYiOiIwLjAuMDAwMCIsIlAiOiJXaW4zMiIsIkFOIjoiTWFpbCIsIldUIjoyfQ%3D%3D%7C0%7C%7C%7C&sdata=f%2BoNpi2wjU578jhHGqAhs%2F%2F6%2B0AVrdXt8wSva1yy7eA%3D&reserved=0) |
...
You must apply using Grants.gov Workspace or a Grants.gov system-to-system solution. You can find this funding opportunity in Grants.gov under number 20250416-XO. There is also a link on the [program resource page.](https://www.neh.gov/program/state-and-impact-humanities)
