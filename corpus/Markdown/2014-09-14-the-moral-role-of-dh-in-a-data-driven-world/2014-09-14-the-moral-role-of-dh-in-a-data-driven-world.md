...
tags: ["big data", "complexity", "data analysis", "network analysis", "privacy", "social networks", "society"]
...
archive_date: "2014-10-21"
archive_timestamp: "20141021005507"

language: "en"
comments_preserved: true
comment_count: 3

source_pdf: "Weingart - 2014 - The moral role of DH in a data-driven world.pdf"
source_pdf_sha256: "58b9a9102e9e27177468ecca913baeb40b123d4268d5640bbf3b414f667cb852"
extraction_date: "2026-08-02"
extraction_tool: "claude scholarly-blog-html-to-markdown skill (from Wayback print PDF)"
extraction_notes: |
  Post date confirmed as 2014-09-14 from the Wayback capture of the blog's monthly archive
  page (scottbot.net), which prints the dateline the single-post print omitted.
  DUPLICATE CONTENT, DIFFERENT SOURCE FILE — PLEASE READ: the existing output
  folder Weingart_2014_Networks_In_and_Of_Society contains THE SAME TEXT as
  this post. It was converted from "Weingart - 2014 - Networks In and Of
  Society.pdf", a PScript5/Distiller print of a different Wayback capture
  (snapshot 2015-07-02) of this same blog post. Its own extraction_notes
  already record that the printed post title is "The moral role of DH in a
  data-driven world"; the file name "Networks In and Of Society" therefore
  appears to be MIS-NAMED — that is a project file-naming artifact, not a
  second work. This conversion is of the file named for the post's own printed
  title, under its own slug. Neither folder was deleted or altered; a future
  editor deciding which to keep should prefer this one, because it is made
  from a Wayback print that preserves the post's category, tags, permalink
  (?p=40944), link annotations and reader comments, none of which survived the
  Distiller print.
  Source is a browser print (2026-03-31) of Wayback snapshot 20141021005507 of
  http://www.scottbot.net/HIAL/?p=40944. The print header truncates the URL;
  the post id was recovered from the snapshot's own reply permalinks
  (?p=40944&replytocom=... on p21).
  POST DATE IS YEAR-ONLY: the Independent Publisher theme printed no dateline.
  The post's three comments are dated 14, 15 and 23 September 2014 and its
  slide images were uploaded to wp-content/uploads/2014/09/, so the post is
  from on or just before 14 September 2014, shortly after the 2014 DH Forum in
  Lawrence, Kansas whose closing keynote it transcribes. The exact day cannot
  be recovered from this print, so the folder uses the permitted <year>-<slug>
  form and the caveat is flagged in the review notes.
  Print header/footer, the Wayback banner, the "Write a Comment" heading
  (Genericons glyph plus label), "Reply to ..." links, three commenter
  avatars, the "READERS WHO SHARED THIS / THANK YOU!" trackback widget and its
  one entry ("DOUBLE EDGED SWORD: THE ANXIETY ABOUT BIG DATA",
  → http://stompingground202.wordpress.com/2014/10/09/double-edged-sword-the-anxiety-about-big-data/),
  the RELATED CONTENT BY TAG cloud (moved to YAML tags) and the theme footer
  credit were stripped as chrome. Category "miscellanea" (?cat=61).
  IMAGES: 17 keynote slides. The theme floats them left or right with the body
  text wrapping beside them, so each is emitted immediately before the
  paragraph that wraps around it. Three slides straddle a page break and the
  print stores each twice — a top crop on the first page plus the complete
  raster positioned off the top of the second; the complete raster was
  extracted once in each case (img-005 from p5's xref, img-009 from p8's,
  img-015 from p17's). Two slides carry link annotations to their full-size
  uploads (slide2.png and slide11.png) and are emitted as linked images; the
  other fifteen are not hyperlinked. The print emitted no figure captions.
  Alt text is descriptive and editor-supplied from the extracted rasters.
  The eighteen numbered section labels ("1. Pale Blue Dot" … "17. Going
  Forward", with 12a and 12b) are set in bold italic at body size in the
  print, i.e. they are emphasised paragraphs rather than headings, and are
  emitted as such; the post's single true heading, "Networked Society", is
  emitted as ##.
  Justified-print end-of-line hyphenation was undone (joins logged in the
  review notes). Five line-end hyphens are authorial and were kept:
  "all-too-easy", "Ice-Bucket", "humanities-supported", "pre-written",
  "two-week". The readings of the ambiguous cases (database, counterargument,
  homepages, backlash, gigabytes, exabytes, micronudging, macrocosms) were
  cross-checked against the independently-converted
  Weingart_2014_Networks_In_and_Of_Society, whose source print does not
  hyphenate, and agree with it.
  Hyperlinks reconstructed from the PDF link annotations and un-rewritten from
  their /web/<timestamp>/ Wayback form; none guessed. The body carries three
  (the PNAS emotional-contagion paper, Nickoal Eichmann, Elijah Meeks) plus
  the two full-size image links.
  Source spellings preserved, including "galaxies.The beauty" (missing space,
  p4) and the commenters' lowercase style.
  All 3 reader comments preserved.
...
![Photograph of the Voyager 1 “Pale Blue Dot”: Earth as a single bright speck in a band of scattered sunlight, captioned “You Are Here” with the speck circled in yellow](images/img-001.png)
...
[![Aerial photograph of Black Rock City, the temporary Burning Man settlement: a huge semicircular grid of camps and roads on a flat Nevada desert, with mountains behind](images/img-002.png)](http://www.scottbot.net/HIAL/wp-content/uploads/2014/09/slide2.png)
...
![Photograph of a starling murmuration — a dense flock of thousands of birds forming a single looping shape against a grey sky](images/img-003.png)
...
![Night-sky photograph with the constellations drawn over it as labelled line networks joining the stars](images/img-004.png)
...
![Dark blue world map criss-crossed by glowing white lines linking the continents into a global network](images/img-005.png)
...
![Photograph of the Voyager 1 “Pale Blue Dot”: Earth as a single bright speck in a band of scattered sunlight, captioned “You Are Here” with the speck circled in yellow](images/img-006.png)
...
![Map of North America overlaid with a dense pink and purple glowing network, captioned “You Are Here” with one node circled in yellow](images/img-007.png)
...
![Aerial photograph of a university campus in autumn — brick and limestone buildings, a clock tower and tree-lined streets — captioned “You Are Here”](images/img-008.png)
...
![Photograph of the entrance to a Target store with shoppers going in and out; the Target bullseye logo is circled in yellow and an arrow labelled “You Are Here” points to it](images/img-009.png)
...
![Map of the United States coloured red and blue by presidential-election result, with the central state circled in yellow and labelled “You Are Here”](images/img-010.png)
...
[![An entirely black image — the blackout slide](images/img-011.png)](http://www.scottbot.net/HIAL/wp-content/uploads/2014/09/slide11.png)
...
![Screenshot of the Facebook home page, “Facebook helps you connect and share with the people in your life”, over a world map of linked user icons with one circled in yellow and captioned “You Are Here”](images/img-012.png)
...
![Scan of a patent-medicine advertisement: “SNAKE-OIL LINIMENT RELIEVES INSTANTANEOUSLY … If You Are Afflicted With Deafness Get Our Specially Prepared PURE Rattlesnake Oil”](images/img-013.png)
...
![Aerial photograph of a large low-rise data-centre complex in a mountain valley, captioned “You Are Here”, with three of its buildings circled and joined by yellow network lines](images/img-014.png)
...
![Photograph of a row of old leather-bound books standing on a shelf, their spines worn and gilt-lettered](images/img-015.png)
...
![Split image: on the left the Pale Blue Dot photograph, on the right a colour photograph of a couple embracing amid the splintered wreckage of a tornado-flattened neighbourhood](images/img-016.png)
...
![Photograph of the Voyager 1 “Pale Blue Dot”: Earth as a single bright speck in a band of scattered sunlight, captioned “You Are Here” with the speck circled in yellow](images/img-017.png)
