...
categories: ["method"]
tags: ["disciplinarity", "history", "history of science", "interdisciplinarity", "methodologies", "scientonomy", "two cultures"]
...
archive_timestamp: "20180307083743"

language: "en"
comments_preserved: true
comment_count: 3

source_pdf: "Weingart - 2014 - Do historians need scientists.pdf"
source_pdf_sha256: "0f9f5e28c55462172d9409f885c53154872438305655a551f5ac4a2b19790c52"
extraction_date: "2026-08-02"
extraction_tool: "claude scholarly-blog-html-to-markdown skill (from Wayback print PDF)"
extraction_notes: |
  Post date confirmed as 2014-02-11 from the Wayback capture of the blog's monthly archive
  page (scottbot.net), which prints the dateline the single-post print omitted.
  Source is a browser print (2026-03-31) of Wayback snapshot 20180307083743
  of the static HIAL mirror of the post (Independent Publisher theme; links
  use the mirror's index.html@... form, un-rewritten from Wayback but kept in
  mirror form as printed; original_url reconstructed from the mirror's
  reply-permalink annotations, index.html@p=40349). POST DATE IS YEAR-ONLY:
  no dateline printed. The first two comments (including the author's reply)
  are dated February 18, 2014 and the post's images live in
  wp-content/uploads/2014/02, so the post is from February 2014 (on or just
  before Feb 18); the third comment is from January 23, 2015. Exact day
  undeterminable offline — folder named <year>-<slug> per convention and
  flagged in review notes.
  Print header/footer, Wayback banner, the mirror's red "NOTE: This is an
  archived version of an old site..." banner, "Write a Comment" heading,
  "Reply to ..." links, comment avatars, the RELATED CONTENT BY TAG cloud
  (moved to YAML from the mirror's @tag= links), and the theme footer credit
  stripped as chrome. Category "method" from the printed "in method" line
  (@cat=60).
  Images: 7 files at native raster resolution. img-001 is the theme's
  featured-image banner (a Gutenberg type close-up not repeated in the
  body); img-006 printed across the p6/p7 break as two raster slices (64px +
  324px), stitched vertically; the other page-break images had complete
  embedded rasters (re-crops discarded). In-body images keep their
  hyperlinks to full-size wp-content uploads. Captions ("Punch matrix
  system. [via]", "Type to be pressed. [via]", "Needham's inventory of
  Gutenberg type. [via]", "Variations in the letter "i" in Gutenberg's
  type. [via]", "Close up of Gutenberg letters, with light shining through
  page. [via]", "Abbreviation of 'per'. [via]") kept as italic caption
  paragraphs with their [via] links (three [via]s point to the Microsoft
  Research video of Agüera y Arcas's talk).
  The opening "[edit: ...]" paragraph kept verbatim with its tweet link.
  ...
  guessed. Source typos preserved (e.g. "invite vampires.Okay" missing
  space, "imagining techniques", "have have a stem", the double space
  before "and so forth" on page 2). 3 reader comments preserved with
  nesting.
...
![Close-up of Gutenberg blackletter type showing “lecti” with ghosting from the reverse of the page (post featured image)](images/img-001.png)
...
[![Punches and matrices of the punchcutting system](images/img-002.png)](http://www.scottbot.net/HIAL/wp-content/uploads/2014/02/punchcutting_punches-matrix1.jpg)

*Punch matrix system. \[[via](http://typofonderie.com/gazette/post/punchcutting-at-imprimerie-nationale/)\]*

[![Movable type set in a forme, ready to be pressed](images/img-003.png)](http://www.scottbot.net/HIAL/wp-content/uploads/2014/02/printing2_large1.jpg)
...
[![Needham’s inventory of Gutenberg type](images/img-004.png)](http://www.scottbot.net/HIAL/wp-content/uploads/2014/02/A9RA25C.png)
...
[![Variations in the letter “i” in Gutenberg’s type](images/img-005.png)](http://www.scottbot.net/HIAL/wp-content/uploads/2014/02/A9RA260.png)
...
[![Close-up of Gutenberg letters with light shining through the page](images/img-006.png)](http://www.scottbot.net/HIAL/wp-content/uploads/2014/02/A9RA262.png)
...
[![Overlapping glyph parts forming the abbreviation of ‘per’](images/img-007.png)](http://www.scottbot.net/HIAL/wp-content/uploads/2014/02/A9RA264.png)
