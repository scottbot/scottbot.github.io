...
categories: ["method"]
tags: ["complexity", "data analysis", "digital humanities", "methodologies"]
...
archive_date: "2015-10-03"
archive_timestamp: "20151003053952"

language: "en"
comments_preserved: true
comment_count: 2

source_pdf: "Weingart - 2012 - On Simplicity.pdf"
source_pdf_sha256: "3f4752b679642f7e0982fe2e5240eff99ad60abef7e5215d4b282764c2e1a93d"
extraction_date: "2026-08-02"
extraction_tool: "claude scholarly-blog-html-to-markdown skill (from Wayback print PDF)"
extraction_notes: |
  Post date confirmed as 2012-09-12 from the Wayback capture of the blog's monthly archive
  page (scottbot.net), which prints the dateline the single-post print omitted.
  Source is a browser print-to-PDF of the Wayback Machine snapshot
  20151003053952 of the post on the later scottbot.net "Independent
  Publisher" theme. The print header truncates the URL
  ("...http://www.scottbot.net..."); the permalink ?p=21129 was recovered
  from the theme's reply-form link annotations (?p=21129&replytocom=...),
  and original_url/archive_url are rebuilt from it. Stripped chrome:
  print header/footer (title, truncated URL, "N of 9", print date
  2/27/2026), the "The Wayback Machine - ..." banner line, the category
  label "in method" (fed into YAML categories via its ?cat=60 link), the
  "Write a Comment" form link, "Reply to ..." links, the "RELATED CONTENT
  BY TAG" widget (fed into YAML tags), the theme footer, and comment
  avatars. This theme prints no dateline. post_date "2012-09" is inferred
  (month precision only, hence the year-only folder slug): both comments
  are dated September 13, 2012, both images live under
  wp-content/uploads/2012/09/, and the epigraph links Ted Underwood's
  post of 2012-08-14. The print is justified with automatic hyphenation;
  line-end hyphens were joined (every join individually verified to be a
  syllable break, not a compound hyphen). The theme sets block quotes in
  italic; italics kept as printed. One visual space lost by the text
  layer ("*good enough*to provide") restored. Images: celestial-
  navigation chart and Jockers network graph extracted at native
  resolution; Ben Schmidt's chart was printed split across pages 6-7 as
  two overlapping rasters, which were stitched back into a single image
  (images/img-003.png, 145-row overlap removed). Each image's hyperlink
  to its full-size upload is kept; alt text supplied from context;
  printed captions kept as paragraphs. Both reader comments preserved
  verbatim (nested reply indented); the comment-body URL
  http://www.jstor.org/stable/270939 is a live link in the source and
  kept as a link.
