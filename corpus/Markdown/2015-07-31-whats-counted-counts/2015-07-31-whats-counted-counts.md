...
tags: ["data analysis", "digital humanities", "diversity", "gender"]

original_url: "http://www.scottbot.net/HIAL/"
archive_url: ""
archive_date: "2015-09-12"
archive_timestamp: "20150912160310"

language: "en"
comments_preserved: false
comment_count: 0

source_pdf: "Weingart - 2015 - What’s Counted Counts.pdf"
source_pdf_sha256: "1d22eafa8a142979aaf3c834d836852ae088f0c65a3d1e643a1384e55b51ef91"
extraction_date: "2026-08-02"
extraction_tool: "claude scholarly-blog-html-to-markdown skill (from Wayback print PDF)"
extraction_notes: |
  Converted from a Firefox/cairo print-to-PDF (4/4/2026) of the Wayback
  Machine snapshot 20150912160310 of the scottbot.net/HIAL post
  (Independent Publisher theme). PROVENANCE: the theme prints NO dateline;
  post_date 2015-07-31 comes from the Related-posts widget of the printed
  2019 post "Modeling Space Ships from Ocean Liners" in this same corpus,
  which lists "What's Counted Counts / July 31, 2015 / In 'miscellanea'".
  The print header truncates the snapshot URL and the HIAL-era ?p=
  permalink is unrecoverable offline, so original_url records the blog
  root and archive_url is empty; archive_timestamp is exact. The post's
  later canonical URL is http://scottbot.net/whats-counted-counts/ (from
  the same 2019 print). Category "miscellanea" from the printed category
  line (links to /HIAL/?cat=61); 4 tags from the theme's RELATED CONTENT
  BY TAG widget. Wayback URL-rewriting prefixes stripped from all links.
  Images: 5 content images extracted from embedded rasters at native
  resolution; four print across page breaks and were recovered whole from
  the full raster embedded on their first page. Justified-print
  hyphenation at line breaks dehyphenated (17 joins, logged in review
  notes); authorial compounds (self-reflective, data-driven) kept.
  Theme comment form ("Write a Comment"), tag widget, and site footer
  stripped as chrome. Footnotes (theme's numbered "Notes:" block)
  converted to Markdown footnote syntax; back-arrow (↩) stripped. No
  reader comments in the snapshot.
...
![Gender representation as authors at DH conferences over the last decade](images/img-001.png)
...
![Saturday Morning Breakfast Cereal comic](images/img-002.png)
...
![Categorisation of baked goods and pancakes in English and Chinese](images/img-003.png)
...
![Pitt Rivers Museum display cabinets](images/img-004.png)
...
![xkcd comic: Useless](images/img-005.png)
