...
publication_type: "blog_post"
container_title: "the scottbot irregular"
journal: ""
volume: ""
issue: ""
pages: ""
publisher: ""
publisher_place: ""
event: "2014 DH Forum, Lawrence, Kansas (closing keynote address)"
...
abstract: ""
keywords: ["big data", "complexity", "data analysis", "network analysis", "privacy", "social networks", "society"]
language: "en"
license: ""

source_pdf: "Weingart - 2014 - Networks In and Of Society.pdf"
source_pdf_sha256: "be98de366922324154834c01412042e7a8a4dce4e03414bcc3546f84ea83b00f"
page_count: 22
extraction_date: "2026-08-01"
extraction_tool: "claude scholarly-pdf-to-markdown skill"
extraction_notes: |
  Source is a print-to-PDF (PScript5/Acrobat Distiller) of an Internet Archive
  Wayback Machine capture (snapshot 2015-07-02, per the banner URL, which is
  printed truncated) of a WordPress blog post on the author's blog "the scottbot
  irregular". The post is the transcript of the author's closing keynote address
  at the 2014 DH Forum in Lawrence, Kansas, as stated in the opening paragraph.
  No formal venue, byline, or publication date is printed anywhere in the PDF:
  author identified from the PDF metadata (Author: "Scott"), the blog identity,
  and the first comment addressing "Scott"; year 2014 from the piece's own text
  and the earliest comment date (September 14, 2014); journal/volume/issue/pages/
  publisher/DOI therefore left empty. The project file name and citation key use
  the title "Networks In and Of Society"; the printed post title is "The moral
  role of DH in a data-driven world" and is used in the YAML. Crossref/network
  was not reachable; all metadata comes from the PDF itself. Keywords are the
  post's tags as printed (styled uppercase) in the related-content widget;
  category label "miscellanea" also printed above the title. Hyperlink targets
  were destroyed by the PostScript print path (0 link annotations); the three
  link anchors visible as colored text in the post body, and three more printed
  as underlined black text in section 17 (detected via underline drawings), are
  rendered as [anchor](#) placeholders. Blog/Wayback/WordPress chrome stripped: archive
  banner, category label, comment-form button, per-comment reply links, share
  and related-content widgets, theme footer, and four 96x96 commenter avatar
  images. Reader comments (4, dated 2014-09-14 to 2015-03-03) are preserved
  under an editorially added "## Comments" heading (the source renders them as
  a styled list without a heading). Source images carry no printed captions, so
  figures are embedded without caption paragraphs; embedded images extracted at
  native web resolution (mostly 300px wide; do-not-upscale rule). Two images
  split across page breaks by the printer (figs 005, 009, 015) were rejoined
  vertically; a few pixel rows lost in the page gutter by the print process.
  Page anchors use the PDF's sequential page numbers (no printed folios).
  Line-end hyphenation (justified text, auto-hyphenated) was removed on join;
  five line-end hyphens judged to be real compound hyphens were kept
  (all-too-easy, two-week, humanities-supported, spot-on, pre-written,
  Ice-Bucket); counterargument and micronudging were closed up (break fell
  mid-morpheme or the closed form is standard). Source typos preserved
  verbatim (e.g. "galaxies.The", "stop the a bills", "lawmakers ultimated
  collected", "holisticly", "conciousness").
...
Today, by zooming in and out, from the distant to the close, I will outline how networks shape our world and our lives, and what we in this room can do to set a path going forward. <!-- page 1 -->
...
I don’t like this picture. From too great a distance, everything looks the same. Every great work of art, every bomb, every life is reduced to a single point. And our collective human experience loses all definition. If we want <!-- page 2 --> to know what makes us, us, we must move a little closer.
...
We call these networks of interactions complex systems, and we study complex systems using network analysis. Network analysis as a methodology takes as a given that nothing can be <!-- page 3 --> properly understood in total isolation. Carl Sagan’s pale blue dot, though poignant and beautiful, is too lonely and too distant to reveal anything of we creatures who inhabit it.
...
Networks open up the world. Over the past four hundred years, the reach of the West extended to the globe, overtaking trade routes created first by eastern conquerors. From these explorations, we produced new <!-- page 4 --> medicines and technologies. Concomitant with this expansion came unfathomable genocide and a slave trade that spanned many continents and far too many centuries.
...
From here, though, it’s impossible to see the hundred hundred towns whose factories have closed down, leaving many unable to feed their families. It’s difficult to see the small but endless inequalities that leave women and minorities <!-- page 6 --> systematically underappreciated and exploited.
...
And this mix of impersonal and individual is how Target makes its way into the wombs of its shoppers. We saw this play out a few years ago when a furious father went to complain to a Target store manager. Why, <!-- page 7 --> he asked the manager, is my *high school daughter* getting ads for maternity products in the mail? After returning home, the father spoke to his daughter to discover she was, indeed pregnant.  How did this happen? How’d Target know?
...
### 10. Presidential Elections <!-- page 8 -->
...
I call bullshit. You’d be hard-pressed to find a period more rife with slavery <!-- page 13 --> and genocide and other horrible breaches of human decency than that Age of Exploration. We can’t sacrifice human decency in the name of progress. On the flip-side, though, we can’t sacrifice progress for the tiniest fears of misconduct. We must proceed with due diligence to ethics without being crippled by inefficacy.
...
The humanities have played some role in this complex machine. During the Cold War, the U.S. government covertly supported artists and authors to create cultural works which would spread American influence abroad and improve American sentiment at home. <!-- page 15 -->
...
### 15. The Humanities’ Place <!-- page 16 -->
...
This is not a humanities problem. It is not a network scientist problem. It is not a question of the ethics of research, but of the ethics of everyday life. Everyone is a network scientist. From Twitter users to newscasters, the boundary between people who consume and people who are aware of and influence the global social network is blurring, and we need to deal with <!-- page 17 --> that. We must collaborate with industries, governments, and publics to become ethical stewards of this networked world we find ourselves in.
...
The challenge of network analysis in the humanities is to bring our close reading perspectives to the distant view, so media companies and governments don’t see everyone as just some statistic, some statistical blip floating on this pale blue dot. <!-- page 19 -->
...
Thanks to [Nickoal Eichmann](#) and [Elijah Meeks](#) for editing & inspiration. <!-- page 20 -->
...
March 3, 2015 <!-- page 21 -->

A topic does not get any more holisticly relevant than this. The delivery was deliberate and near spotless. I hope to incorporate this message into day to day conciousness. Thank you. <!-- page 22 -->
